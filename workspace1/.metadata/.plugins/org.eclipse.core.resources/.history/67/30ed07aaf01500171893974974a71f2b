...
public class CRC16 {  
    ...
    public static void main(String[] args) {  
    	...
    	//String address = Integer.toHexString(127);
    	
    	int crc = CRC16.calcCrc16(new byte[]{(byte)0x7f,03,00,01});
    	System.out.print(String.format("%04x", crc));
    	String data = String.format("%04x", crc);
