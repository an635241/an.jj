package com.topsports.weixin.base.service;
...
import com.topsports.weixin.base.common.enums.CommonOperatorEnum;
import com.topsports.weixin.base.common.enums.DataAccessRuleEnum;
...
import com.topsports.weixin.base.dao.BaseCurdMapper;
...
public abstract class BaseCurdService {
	...
	public int findCount(Map<String,Object> params) throws ServiceException {
		try {
			return mapper.selectCount(params,null);
		} catch (Exception e) {
			throw new ServiceException("",e);
		}
	}
	...
	public int findCount(Map<String, Object> params, AuthorityParams authorityParams) throws ServiceException {
		try {
			return mapper.selectCount(params,authorityParams);
		} catch (Exception e) {
			throw new ServiceException("",e);
		}
	}
	...
	public int findCount(Map<String, Object> params, AuthorityParams authorityParams,
			DataAccessRuleEnum... dataAccessRuleEnums) throws ServiceException {
		try {
			return this.findCount(params, authorityParams);
	...
	public <ModelType> List<ModelType> findByPage(SimplePage page, String orderByField, String orderBy,
		...
		try {
			return mapper.selectByPage(page, orderByField, orderBy,params,authorityParams);
		} catch (Exception e) {
			throw new ServiceException("",e);
		}
	}
	...
	public <ModelType> List<ModelType> findByPage(SimplePage page, String orderByField, String orderBy,
		...
		try {
			return this.findByPage(page, orderByField, orderBy, params, authorityParams);
		} catch (ServiceException e) {
			throw e;
		}
	}
