	...
	$.fn.resizable = function(_1, _2) {
		...
		return this.each(function() {
			...
			if (_e) {
				...
				_d = $.extend({}, $.fn.resizable.defaults, $.fn.resizable
						.parseOptions(this), _1 || {});
				$.data(this, "resizable", {
					options : _d
				});
			}
			...
			function _10(e) {
				...
				if (e.pageY > _13.top && e.pageY < _13.top + _16) {
					...
					if (e.pageY < _13.top + _15
							&& e.pageY > _13.top + _15 - _16) {
						dir += "s";
					}
				}
				if (e.pageX > _13.left && e.pageX < _13.left + _16) {
					...
					if (e.pageX < _13.left + _14
							&& e.pageX > _13.left + _14 - _16) {
						dir += "e";
					}
				}
		...
		$.each(opt.items,
				function() {
					...
					if (items.length == 1) {
						...
						} else if (items.handler
								&& typeof items.handler === 'function') {
							if (!items.disabled) {
	...
	$.fn.toolbar.methods = {
		...
		select : function(index) {
			return this.each(function() {
				...
				var target = $(this);
				target.children().removeClass('l-btn-plain-selected')
						.removeClass('l-btn-selected');
				 ...
				 * 
				 * if(v != "-"){ if(v.type == 'menubutton'){
				 * ld.menubutton('select',index); }else{
				 * ld.linkbutton('select',index); } if(v.handler){
				 * ld.unbind('click'); } } })
				 */
			});
		},
...
(function($) {
	...
	function _13(_14) {
		...
		if (_15.tools && typeof _15.tools == "string") {
			_16.find(">div.panel-header>div.panel-tool .panel-tool-a")
					.appendTo(_15.tools);
		}
		...
		if (_15.title && !_15.noheader || _15.minSplit) {
				...
				if ($.isArray(_15.tools)) {
					for (var i = 0; i < _15.tools.length; i++) {
						var t = $("<a href=\"javascript:void(0)\"></a>")
								.addClass(_15.tools[i].iconCls).appendTo(_18);
			...
			if (_15.collapsible) {
				$(
						...
						.appendTo(_18).bind("click", function() {
	...
	function _2c(_36, _37) {
		...
		var _3b = _39.children("div.panel-header")
	...
	function _3c(_3d, _3e) {
		...
		var _42 = _40.children("div.panel-header")
				.find("a.panel-tool-collapse");
...
(function($) {
	...
	function _1b(_1c, _1d, el) {
		...
		var _1f = $.extend({}, $.fn.layout.paneldefaults, {
			...
			onOpen : function() {
				...
				if (!t.length) {
					t = $("<a href=\"javascript:void(0)\"></a>").addClass(_22)
							.appendTo(_20);
					t.bind("click", {
						dir : dir
					}, function(e) {
		...
		if (pp.panel("options").split || pp.panel("options").minSplit) {
			...
			if (pp.panel("options").minSplit) {
				...
				panel
						.append('<a class="layout-button-left" href="javascript:void(0)"></a>');
			}
			// min-split 扩展 end
			...
			$(
					'.layout-button-left,.layout-button-right,.layout-button-down,.layout-button-up')
					.mousedown(function() {
						return false;
					});
			_23
							...
							.extend(
									{},
									{
										...
										onStartResize : function(e) {
											...
											if (dir == "north") {
												pos.top = parseInt(_23
														.css("top"))
														+ _23.outerHeight()
														- _25.height();
												pos.left = parseInt(_23
														.css("left"));
	...
	function _2a(_2b, _2c) {
		...
		if (_2d[_2c].length) {
			...
			_2d[_2c] = $();
			var _2e = "expand" + _2c.substring(0, 1).toUpperCase()
					+ _2c.substring(1);
			if (_2d[_2e]) {
	...
	function _2f(_30, _31, _32) {
		...
		var _35 = "expand" + _31.substring(0, 1).toUpperCase()
				+ _31.substring(1);
		if (!_33[_35]) {
			_33[_35] = _36(_31);
			_33[_35].panel("panel").bind(
					"click",
					function() {
						var _37 = _38();
		...
		function _36(dir) {
			...
			if (_33[_31].panel("options").minSplit) {
				p.panel("panel").addClass(
						'layout-min-split layout-expand-' + _31);
			}
				...
				if (_31 == "west") {
					...
					if (_31 == "north") {
						...
						if (!_9(_33.expandNorth)) {
							hh += _34.height - splitWidth
									+ ((_34.split || !_34.border) ? 1 : 0);
						}
						_33.east.add(_33.west).add(_33.expandEast).add(
	...
	function _3c(_3d, _3e) {
		...
		var _41 = _42();
		var _43 = "expand" + _3e.substring(0, 1).toUpperCase()
				+ _3e.substring(1);
		if (_3f[_43]) {
			_3f[_43].panel("close");
			p.panel("panel").stop(true, true);
			p.panel("expand", false).panel("open")
					.panel("resize", _41.collapse);
		...
		function _42() {
			...
			if (_3e == "east" && _3f.expandEast) {
				return {
					...
					expand : {
						left : cc.width() - _3f["east"].panel("options").width
					}
				};
			} else {
				if (_3e == "west" && _3f.expandWest) {
					return {
						collapse : {
							left : -_3f["west"].panel("options").width,
							top : _44.top,
							height : _44.height
						},
						expand : {
					...
					if (_3e == "north" && _3f.expandNorth) {
						return {
							collapse : {
								top : -_3f["north"].panel("options").height,
								width : cc.width()
							},
							expand : {
								top : 0
						...
						if (_3e == "south" && _3f.expandSouth) {
							return {
								...
								expand : {
									top : cc.height()
											- _3f["south"].panel("options").height
								}
							};
						}
					}
	...
	$.fn.layout = function(_48, _49) {
		...
		return this.each(function() {
			...
			if (_4a) {
				...
				var _4b = $.extend({}, $.fn.layout.defaults, $.fn.layout
						.parseOptions(this), _48);
				$.data(this, "layout", {
					options : _4b,
					panels : {
						center : $(),
		...
		add : function(jq, _4f) {
			return jq
					.each(function() {
						_1b(this, _4f);
						_2(this);
						if ($(this).layout("panel", _4f.region)
	...
	$.fn.layout.parseOptions = function(_51) {
		return $.extend({}, $.parser.parseOptions(_51, [ {
			fit : "boolean"
		} ]));
	};
	$.fn.layout.defaults = {
	...
	$.fn.layout.parsePanelOptions = function(_52) {
		var t = $(_52);
		return $.extend({}, $.fn.panel.parseOptions(_52), $.parser
				.parseOptions(_52, [ "region", {
					split : "boolean",
					minWidth : "number",
					minHeight : "number",
					maxWidth : "number",
...
(function($) {
	function _1(_2) {
		...
		if (_3.selected) {
			t.addClass(_3.plain ? "l-btn-selected l-btn-plain-selected"
					: "l-btn-selected");
		}
		...
		if (_3.text) {
			...
			if (_3.iconCls) {
				t.find(".l-btn-text").addClass(_3.iconCls).addClass(
						_3.iconAlign == "left" ? "l-btn-icon-left"
								: "l-btn-icon-right");
			}
		} else {
	...
	function _4(_6, _7) {
		...
		if (_7) {
			...
			$(_6).addClass(
					_8.plain ? "l-btn-selected l-btn-plain-selected"
							: "l-btn-selected");
			_8.selected = true;
		} else {
			if (!_8.group) {
	...
	function _5(_9, _a) {
		...
		if (_a) {
			...
			_c.plain ? $(_9).addClass("l-btn-disabled l-btn-plain-disabled")
					: $(_9).addClass("l-btn-disabled");
		} else {
			_c.disabled = false;
			if (_b.href) {
			...
			if (_10) {
				...
				$.data(this, "linkbutton", {
					options : $.extend({}, $.fn.linkbutton.defaults,
							$.fn.linkbutton.parseOptions(this), _e)
				});
	...
	$.fn.linkbutton.parseOptions = function(_11) {
		var t = $(_11);
		return $.extend({}, $.parser.parseOptions(_11, [ "id", "iconCls",
				"iconAlign", "group", {
					plain : "boolean",
					toggle : "boolean",
					selected : "boolean"
...
(function($) {
	...
	var _179 = {
		text : {
			init : function(_17a, _17b) {
				var _17c = $(
						...
						.appendTo(_17a);
				/**
				 * BEGIN Modify: he.ff Data: 2014/06/09
				 * 
				 * @property: disabled
				 */
				_17b = _17b || {};
		...
		validatebox : {
			 ...
			 * ,datebox:{init:function(_1a3,_1a4){ var _1a5=$("<input
			 * type=\"text\">").appendTo(_1a3); alert(1); _1a5.datebox(_1a4);
			 * return _1a5; },destroy:function(_1a6){
			 * $(_1a6).datebox("destroy"); },getValue:function(_1a7){ return
			 * $(_1a7).val(); },setValue:function(_1a8,_1a9){ $(_1a8).val(_1a9); }}
			 */,
		combobox : {
		...
		loaded : function(jq) {
			return jq.each(function() {
				...
				if ($(this).datagrid("getRows").length <= 0
						&& opts.emptyMsg != "") {
					$(this).before(
							'<div class="datagrid-empty-msg">' + opts.emptyMsg
									+ '</div>');
				} else {
...
var detailview = $
		.extend(
				...
				$.fn.datagrid.defaults.view,
				{
					render : function(target, container, frozen) {
						...
						for (var i = 0; i < rows.length; i++) {
							...
							if (frozen) {
								...
								table
										.push('<td style="vertical-align:top;padding-right:10px;" colspan='
												+ (fields.length) + '>');
							}
					...
					renderRow : function(target, fields, frozen, rowIndex,
						...
						for (var i = 0; i < fields.length; i++) {
							...
							if (col) {
								...
								var css = col.styler ? (col.styler(value,
										rowData, rowIndex) || '') : '';
								var classValue = '';
								var styleValue = '';
								if (typeof css == 'string') {
								...
								if (col.checkbox) {
									...
									// cc.push('<div
									// style="text-align:center;width:16px;height:16px;">');
									cc
									...
									cc.push(col.formatter(value, rowData,
											rowIndex));
								} else {
									cc.push(value);
								}
					...
					bindEvents : function(target) {
						...
						var clickHandler = ($.data(body[0], 'events') || $
								._data(body[0], 'events')).click[0].handler;
						body
								.unbind('click')
								.bind(
										'click',
										function(e) {
											...
											if (tt
													.hasClass('datagrid-row-expander')) {
												var rowIndex = parseInt(tr
														.attr('datagrid-row-index'));
												$(target).datagrid('selectRow',
														rowIndex);
												if (tt
					...
					onBeforeRender : function(target) {
						...
						var fields = t.datagrid('getColumnFields', true)
								.concat(t.datagrid('getColumnFields'));
						for (var i = 0; i < fields.length; i++) {
						...
						if (!hasExpander) {
							...
							var t = dc.view1.children('div.datagrid-header')
									.find('table');
							var td = $('<td rowspan="'
	...
	$.extend(
				$.fn.datagrid.methods,
				{
					...
					getExpander : function(jq, index) { // get row expander
														// object
						var opts = $.data(jq[0], 'datagrid').options;
						return opts.finder.getTr(jq[0], index).find(
						...
						return jq
								.each(function() {
									...
									if (expander
										...
										var tr1 = opts.finder.getTr(this,
												index, 'body', 1).next();
										var tr2 = opts.finder.getTr(this,
												index, 'body', 2).next();
										tr1.show().height(150);
										tr2.show();
										...
										if (opts.onExpandRow) {
											var row = $(this).datagrid(
													'getRows')[index];
											opts.onExpandRow.call(this, index,
													row);
										}
									}
								});
...
(function($) {
	function _1(_2) {
		...
		function _6(_a) {
			...
			if (_a.hasClass("menu-content")) {
				...
				_a.children("div").each(
						function() {
							var _c = $(this);
							var _d = $.extend({}, $.parser.parseOptions(this, [
									"name", "iconCls", "href", {
										separator : "boolean"
									} ]), {
								disabled : (_c.attr("disabled") ? true
										: undefined)
							});
							if (_d.separator) {
							...
							if (!_c.hasClass("menu-sep")) {
								...
								if (_d.iconCls) {
									$("<div class=\"menu-icon\"></div>")
											.addClass(_d.iconCls).appendTo(_c);
								}
								if (_d.disabled) {
									_f(_2, _c[0], true);
								}
	...
	function _11(_13, _14) {
		...
		_17 += 65;
		_14._outerWidth(Math
				.max((_14[0].originalWidth || 0), _17, _15.minWidth));
	...
	function _25(_26, _27) {
		...
		if (_29.hasClass("menu-top")) {
			...
			if (_28 + _29.outerWidth() > $(window)._outerWidth()
					+ $(document)._scrollLeft()) {
				_28 = $(window)._outerWidth() + $(document).scrollLeft()
						- _29.outerWidth() - 5;
			}
			if (top + _29.outerHeight() > $(window)._outerHeight()
					+ $(document).scrollTop()) {
			...
			if (_28 + _29.outerWidth() + 5 > $(window)._outerWidth()
					+ $(document).scrollLeft()) {
		...
		_29.show(0, function() {
			if (!_29[0].shadow) {
				_29[0].shadow = $("<div class=\"menu-shadow\"></div>")
						.insertAfter(_29);
			}
			_29[0].shadow.css({
				display : "block",
	...
	function _38(_39, _3a) {
		...
		if (_3a.iconCls) {
			$("<div class=\"menu-icon\"></div>").addClass(_3a.iconCls)
					.appendTo(_3d);
		}
		if (_3a.id) {
			_3d.attr("id", _3a.id);
			...
			if (_47) {
				...
				_47 = $.data(this, "menu", {
					options : $.extend({}, $.fn.menu.defaults, $.fn.menu
							.parseOptions(this), _45)
				});
				_1(this);
			}
			$(this).css({
				left : _47.options.left,
				top : _47.options.top
			});
		});
	};
	$.fn.menu.methods = {
		...
		setIcon : function(jq, _49) {
			return jq.each(function() {
				...
				if (_4a.iconCls) {
					$(_4a.target).children("div.menu-icon").removeClass(
							_4a.iconCls).addClass(_49.iconCls);
				} else {
					$("<div class=\"menu-icon\"></div>").addClass(_49.iconCls)
							.appendTo(_49.target);
				}
			});
		},
	...
	$.fn.menu.parseOptions = function(_53) {
		return $.extend({}, $.parser.parseOptions(_53, [ "left", "top", {
			minWidth : "number",
...
(function($) {
	function _1(_2) {
		...
		_4.linkbutton($.extend({}, _3, {
			text : _3.text + "<span class=\"" + _3.cls.arrow
					+ "\">&nbsp;</span>"
		}));
		if (_3.menu) {
			$(_3.menu).menu();
			...
			$.extend(_5,
					{
						onShow : function() {
							...
							_9.addClass((_a.plain == true) ? _a.cls.btn2
									: _a.cls.btn1);
							_6.call(this);
						},
						onHide : function() {
							...
							_c.removeClass((_d.plain == true) ? _d.cls.btn2
									: _d.cls.btn1);
							_7.call(this);
						}
					});
			...
			if (_19) {
				...
				$.data(this, "menubutton", {
					options : $.extend({}, $.fn.menubutton.defaults,
							$.fn.menubutton.parseOptions(this), _16)
				});
				$(this).removeAttr("disabled");
			}
			_1(this);
	...
	$.fn.menubutton.parseOptions = function(_1d) {
		var t = $(_1d);
		return $.extend({}, $.fn.linkbutton.parseOptions(_1d), $.parser
				.parseOptions(_1d, [ "menu", {
					plain : "boolean",
					duration : "number"
				} ]));
	};
...
(function($) {
	function _1(_2) {
		...
		var _4 = $("<input type=\"text\" class=\"searchbox-text\">").appendTo(
				_3);
	...
	function _e(_f) {
		...
		function _13(_16) {
			...
			_10.searchbox.find("input.searchbox-text").attr("name",
					_16.name || _16.text);
			_6(_f);
		}
		;
	...
	$.fn.searchbox = function(_22, _23) {
		...
		return this.each(function() {
			...
			if (_24) {
				...
				_24 = $.data(this, "searchbox", {
					options : $.extend({}, $.fn.searchbox.defaults,
							$.fn.searchbox.parseOptions(this), _22),
					searchbox : _1(this)
				});
			}
			_e(this);
	...
	$.fn.searchbox.methods = {
		...
		selectName : function(jq, _26) {
			return jq.each(function() {
				...
				if (_27) {
					_27.children("div.menu-item[name=\"" + _26 + "\"]")
	...
	$.fn.searchbox.parseOptions = function(_2a) {
		var t = $(_2a);
		return $.extend({}, $.parser.parseOptions(_2a, [ "width", "height",
				"prompt", "menu" ]), {
			value : t.val(),
...
(function($) {
	...
	function _6(_a) {
		...
		_d.css({
			left : _e,
			top : _f,
			zIndex : (_c.zIndex != undefined ? _c.zIndex
	...
	function _14(_1a, _1b) {
		...
		var cc = typeof _1d.content == "function" ? _1d.content.call(_1a)
				: _1d.content;
	...
	$.fn.tooltip.parseOptions = function(_26) {
		var t = $(_26);
		var _27 = $.extend({}, $.parser.parseOptions(_26, [ "position",
	...
	function _1e(_1f) {
		...
		if (!_21.disabled && !_21.readonly) {
			_24.bind(
					...
					$.browser.mozilla ? "keyup.combo" : "keydown.combo",
					function(e) {
						switch (e.keyCode) {
						case 38:
							...
							if (_21.editable) {
								...
								_20.timer = setTimeout(function() {
									...
									if (_20.previousValue != q) {
										_20.previousValue = q;
										$(_1f).combo("showPanel");
										_21.keyHandler.query.call(_1f, _24
												.val(), e);
										$(_1f).combo("validate");
									}
								}, _21.delay);
	...
	$.fn.combo.methods = {
		...
		setValues : function(jq, _6c) {
			return jq.each(function() {
				...
				$(this).next('.combo').find('.combo-value').attr(
						'defaultValue', _65.originalValue);
			});
		},
		getValue : function(jq) {
			return _59(jq[0]);
...
(function($) {
	...
	function _1d(_24, _25, _26) {
		...
		_28.find("div.combobox-item-selected").removeClass(
		...
		for (var i = 0; i < _2c.length; i++) {
			...
			if (g) {
				if (_31 != g) {
					...
					var _32 = {
						value : g,
						domId : ("_easyui_combobox_" + _29++)
					};
					_2e.groups.push(_32);
					dd.push("<div id=\"" + _32.domId
							+ "\" class=\"combobox-group\">");
					dd.push(_2f.groupFormatter ? _2f.groupFormatter
							.call(_2b, g) : g);
					dd.push("</div>");
				}
			} else {
			...
			if (_52) {
				...
				_52 = $.data(this, "combobox", {
					options : $.extend({}, $.fn.combobox.defaults,
							$.fn.combobox.parseOptions(this), _4f),
					data : []
				});
				_49(this);
	...
	$.fn.combobox.methods = {
		...
		clear : function(jq) {
			return jq.each(function() {
				...
				_57.find("div.combobox-item-selected").removeClass(
						"combobox-item-selected");
			});
		},
		reset : function(jq) {
	...
	$.fn.combobox.parseOptions = function(_5c) {
		var t = $(_5c);
		return $.extend({}, $.fn.combo.parseOptions(_5c), $.parser
				.parseOptions(_5c, [ "valueField", "textField", "groupField",
						"mode", "method", "url" ]));
	};
	$.fn.combobox.parseData = function(_5d) {
		...
		function _61(el, _62) {
			var t = $(el);
			var row = {};
			row[_5f.valueField] = t.attr("value") != undefined ? t
					.attr("value") : t.html();
	...
	$.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults,
			{
				...
				filter : function(q, row) {
					...
					return row[_64.textField].toLowerCase().indexOf(
							q.toLowerCase()) == 0;
				},
...
var $dp, WdatePicker;(function(){var $={
	...
	function J() {
		...
		for (var B = 0; B < $.length; B++) {
			...
			_ = _.substr(0, _.toLowerCase().indexOf("ui.js"));
			A = _.lastIndexOf("/");
			if (A > 0)
				_ = _.substring(0, A + 1);
			if (_)
	...
	$.fn.datebox = function(options, params) {
		...
		return this.each(function() {
			...
			if (data) {
				...
				newOptions = $.extend({}, $.fn.datebox.defaults, $.fn.datebox
...
(function($) {
	...
	function _12(e) {
		...
		_13.droppables
				.each(function() {
					...
					var p2 = _15.offset();
					if (e.pageX > p2.left
							&& e.pageX < p2.left + _15.outerWidth()
							&& e.pageY > p2.top
							&& e.pageY < p2.top + _15.outerHeight()) {
						if (!this.entered) {
	...
	function _16(e) {
		...
		function _1a() {
			...
			_17.droppables.each(function() {
				...
				var p2 = _1e.offset();
				if (e.pageX > p2.left && e.pageX < p2.left + _1e.outerWidth()
						&& e.pageY > p2.top
						&& e.pageY < p2.top + _1e.outerHeight()) {
					if (_19.revert) {
						$(e.data.target).css({
							position : e.data.startPosition,
							left : e.data.startLeft,
	...
	$.fn.draggable = function(_1f, _20) {
		...
		return this.each(function() {
			...
			if (_22) {
				...
				_21 = $.extend({}, $.fn.draggable.defaults, $.fn.draggable
						.parseOptions(this), _1f || {});
			}
			var _23 = _21.handle ? (typeof _21.handle == "string" ? $(
					_21.handle, this) : _21.handle) : $(this);
			$.data(this, "draggable", {
				options : _21,
				handle : _23
			});
	...
	$.fn.draggable.parseOptions = function(_2f) {
		var t = $(_2f);
		return $.extend({}, $.parser.parseOptions(_2f, [ "cursor", "handle",
				"axis", {
					"revert" : "boolean",
					"deltaX" : "number",
					"deltaY" : "number",
			...
			if (_9) {
				...
				$.data(this, "droppable", {
					options : $.extend({}, $.fn.droppable.defaults,
							$.fn.droppable.parseOptions(this), _7)
				});
			}
		});
	};
...
(function($) {
			...
			if (_b) {
				...
				_b = $.data(this, "progressbar", {
					options : $.extend({}, $.fn.progressbar.defaults,
							$.fn.progressbar.parseOptions(this), _8),
					bar : _1(this)
				});
			}
	...
	$.fn.progressbar.parseOptions = function(_11) {
		return $.extend({}, $.parser.parseOptions(_11, [ "width", "height",
				"text", {
					value : "number"
				} ]));
	};
...
(function($) {
	...
	function _11(_12) {
				...
				.droppable(
						{
							...
							onDragEnter : function(e, _1a) {
								if (_14.onDragEnter.call(_12, this,
										_c(_12, _1a)) == false) {
									_1b(_1a, false);
									$(this)
											.removeClass(
							...
							onDragOver : function(e, _1c) {
								...
								if (_14.onDragOver
										.call(_12, this, _c(_12, _1c)) == false) {
									_1b(_1c, false);
									$(this)
											.removeClass(
													"tree-node-append tree-node-top tree-node-bottom");
							...
							onDrop : function(e, _20) {
								...
								if ($(this).hasClass("tree-node-append")) {
									...
									_22 = _25;
									_23 = $(this).hasClass("tree-node-top") ? "top"
											: "bottom";
								}
								if (_14.onBeforeDrop.call(_12, _21, _c2(_12,
										_20), _23) == false) {
									$(this)
											.removeClass(
													"tree-node-append tree-node-top tree-node-bottom");
		...
		function _1b(_26, _27) {
			...
			_28.removeClass("tree-dnd-yes tree-dnd-no").addClass(
					_27 ? "tree-dnd-yes" : "tree-dnd-no");
		}
		;
			...
			if (ck.length) {
				...
				if (_44.onlyLeafCheck) {
					$("<span class=\"tree-checkbox tree-checkbox0\"></span>")
							.insertBefore(_45.find(".tree-title"));
				}
			}
		} else {
			var ck = _45.find(".tree-checkbox");
	...
	function _4b(_4c, ul, _4d, _4e) {
		...
		if (!_4e) {
			...
			if (_52) {
				_52.children ? _52.children = _52.children.concat(_4d)
						: _52.children = _4d;
			} else {
	...
	function _5a(_5b, ul, _5c) {
		...
		if (!_5c) {
			_5c = true;
			$(_5b).find("span.tree-indent").removeClass(
					"tree-line tree-join tree-joinbottom");
			$(_5b).find("div.tree-node").removeClass(
		...
		var _62 = $(ul).children("li:last").children("div.tree-node").addClass(
				"tree-node-last");
		_62.children("span.tree-join").removeClass("tree-join").addClass(
				"tree-joinbottom");
		...
		function _60(_66) {
			...
			_66.next().find("div.tree-node").each(
					function() {
						$(this).children("span:eq(" + (_67 - 1) + ")")
								.addClass("tree-line");
					});
		}
		;
		...
		if (c[0].tagName != "BODY") {
			...
			if (_8d < _8e) {
				...
				if (_8d + n.outerHeight() > _8e + c.outerHeight() - 18) {
					c.scrollTop(c.scrollTop() + _8d + n.outerHeight() - _8e
							- c.outerHeight() + 18);
				}
			}
		} else {
	...
	function _93(_94, _95) {
		...
		if (_96.length == 0) {
			...
			if (_46(_94, _96[0])) {
				...
				_98.removeClass("tree-file").addClass(
	...
	function _9e(_9f, _a0) {
		...
		if (_a1) {
			if (!_a1.children || !_a1.children.length) {
				var _a2 = $(_a1.target);
				_a2.find(".tree-icon").removeClass("tree-folder").addClass(
						"tree-file");
	...
	function _dd(_de, _df) {
		...
		_e3.width(_e2 + 20);
		_e3.height(document.compatMode == "CSS1Compat" ? (18 - (_e3
				.outerHeight() - _e3.height())) : 18);
	...
	$.fn.tree = function(_ef, _f0) {
		...
		return this.each(function() {
			...
			if (_f1) {
				...
				_f2 = $.extend({}, $.fn.tree.defaults, $.fn.tree
						.parseOptions(this), _ef);
				$.data(this, "tree", {
					options : _f2,
					tree : _1(this),
					data : []
	...
	var _114 = {
		render : function(_115, ul, data) {
			...
			var _116 = $(ul).prev("div.tree-node").find(
			...
			function _117(_118, _119) {
				...
				for (var i = 0; i < _119.length; i++) {
					...
					cc.push("<span class=\"tree-title\">"
							+ opts.formatter.call(_115, item) + "</span>");
					cc.push("</div>");
					if (item.children && item.children.length) {
...
(function($) {
	...
	function _13(_14, _15) {
		...
		_17.find("span.tree-checkbox").addClass("tree-checkbox0").removeClass(
			...
			if (_1c) {
				...
				$.data(this, "combotree", {
					options : $.extend({}, $.fn.combotree.defaults,
							$.fn.combotree.parseOptions(this), _19)
				});
			}
			_1(this);
		});
	...
	$.fn.combotree.methods = {
		...
		clear : function(jq) {
			return jq.each(function() {
				...
				_25.find("div.tree-node-selected").removeClass(
						"tree-node-selected");
	...
	$.fn.combotree.parseOptions = function(_27) {
		return $.extend({}, $.fn.combo.parseOptions(_27), $.fn.tree
				.parseOptions(_27));
	};
...
(function($) {
			...
			if (_35) {
				...
				_35 = $.data(this, "combogrid", {
					options : $.extend({}, $.fn.combogrid.defaults,
							$.fn.combogrid.parseOptions(this), _32)
				});
			}
			_1(this);
		});
	...
	$.fn.combogrid.parseOptions = function(_3a) {
		var t = $(_3a);
		return $.extend({}, $.fn.combo.parseOptions(_3a), $.fn.datagrid
				.parseOptions(_3a), $.parser.parseOptions(_3a, [ "idField",
				"textField", "mode" ]));
	};
...
(function($) {
			...
			if (_1c) {
				...
				_1c = $.data(this, "numberbox", {
					options : $.extend({}, $.fn.numberbox.defaults,
							$.fn.numberbox.parseOptions(this), _19),
					field : _1(this)
				});
				$(this).removeAttr("disabled");
				$(this).css({
	...
	$.fn.numberbox.parseOptions = function(_20) {
		var t = $(_20);
		return $.extend({}, $.fn.validatebox.parseOptions(_20), $.parser
					...
					$.fn.validatebox.defaults,
					{
						...
						formatter : function(_22) {
							...
							if (_23.groupSeparator) {
								...
								while (p.test(s1)) {
									s1 = s1.replace(p, "$1"
											+ _23.groupSeparator + "$2");
								}
							}
							if (s2) {
								return _23.prefix + s1 + _23.decimalSeparator
										+ s2 + _23.suffix;
							} else {
						...
						parser : function(s) {
							...
							if (parseFloat(s) != s) {
								...
								if (_25.groupSeparator) {
									s = $.trim(s.replace(new RegExp("\\"
											+ _25.groupSeparator, "g"), ""));
								}
								if (_25.decimalSeparator) {
									s = $.trim(s.replace(new RegExp("\\"
											+ _25.decimalSeparator, "g"), "."));
								}
								s = s.replace(/\s/g, "");
							}
							...
							if (isNaN(val)) {
								...
								if (typeof (_25.min) == "number"
										&& val < _25.min) {
									val = _25.min.toFixed(_25.precision);
								} else {
									if (typeof (_25.max) == "number"
											&& val > _25.max) {
...
(function($) {
			...
			for (var i = 0; i < aa.length; i++) {
				...
				if (aa[i] != "|") {
					...
					if (_f.mode == "h") {
						_15.css({
							left : _14,
							marginLeft : -Math.round(_15.outerWidth() / 2)
						});
					} else {
						_15.css({
							top : _14,
							marginTop : -Math.round(_15.outerHeight() / 2)
						});
					}
				}
			}
	...
	function _16(_17) {
		...
		_1a.find("a.slider-handle").draggable(
				{
					...
					onStopDrag : function(e) {
						var _1f = _32(_17, (_19.mode == "h" ? e.data.left
								: e.data.top));
						_1e(_1f);
		...
		_1a.find("div.slider-inner").unbind(".slider").bind(
				"mousedown.slider",
				function(e) {
					if (_18.isDragging) {
						return;
					...
					var pos = $(this).offset();
					var _20 = _32(_17, (_19.mode == "h" ? (e.pageX - pos.left)
							: (e.pageY - pos.top)));
					_1e(_20);
					_19.onComplete.call(_17, _19.value);
				});
	...
	function _22(_23, _24) {
		...
		if (_26.mode == "h") {
			...
			tip.attr("style", _2a + "margin-left:"
	...
	function _29(_2d, _2e) {
		...
		if (_30.mode == "h") {
			...
			var pos = _31.height() - (_2e - _30.min) / (_30.max - _30.min)
					* _31.height();
			if (_30.reversed) {
				pos = _31.height() - pos;
			}
	...
	function _32(_33, pos) {
		...
		if (_35.mode == "h") {
			...
			var _37 = _35.min + (_35.max - _35.min)
					* ((_36.height() - pos) / _36.height());
		}
	...
	$.fn.slider.parseOptions = function(_40) {
		var t = $(_40);
		return $.extend({}, $.parser.parseOptions(_40, [ "width", "height",
				"mode", {
					reversed : "boolean",
					showTip : "boolean",
					min : "number",
...
(function($) {
	...
	function _2(_3) {
		...
		$(_3).datagrid($.extend({}, _5, {
			cls : "propertygrid",
			view : (_5.showGroup ? _5.groupView : _5.view),
			onClickRow : function(_6, _7) {
				if (_1 != this) {
					_a(_1);
					_1 = this;
				}
	...
	$.fn.propertygrid = function(_e, _f) {
		...
		return this.each(function() {
			...
			if (_11) {
				...
				var _12 = $.extend({}, $.fn.propertygrid.defaults,
						$.fn.propertygrid.parseOptions(this), _e);
	...
	$.fn.propertygrid.parseOptions = function(_13) {
		return $.extend({}, $.fn.datagrid.parseOptions(_13), $.parser
				.parseOptions(_13, [ {
					showGroup : "boolean"
				} ]));
	};
	var _14 = $
			.extend(
					...
					$.fn.datagrid.defaults.view,
					{
						render : function(_15, _16, _17) {
							var _18 = [];
							var _19 = this.groups;
							for (var i = 0; i < _19.length; i++) {
								_18.push(this.renderGroup.call(this, _15, i,
										_19[i], _17));
							}
							$(_16).html(_18.join(""));
						},
						renderGroup : function(_1a, _1b, _1c, _1d) {
							...
							_21.push("<tr>");
							if ((_1d && (_1f.rownumbers || _1f.frozenColumns.length))
									|| (!_1d && !(_1f.rownumbers || _1f.frozenColumns.length))) {
								_21
							...
							if (!_1d) {
								...
								_21.push(_1f.groupFormatter.call(_1a,
										_1c.value, _1c.rows));
								_21.push("</span>");
							}
							_21.push("</td>");
							...
							for (var j = 0; j < _1c.rows.length; j++) {
								var css = _1f.rowStyler ? _1f.rowStyler.call(
										_1a, _22, _1c.rows[j]) : "";
								var _23 = "";
								var _24 = "";
								if (typeof css == "string") {
								...
								var cls = "class=\"datagrid-row "
										+ (_22 % 2 && _1f.striped ? "datagrid-row-alt "
												: " ") + _23 + "\"";
								var _25 = _24 ? "style=\"" + _24 + "\"" : "";
								var _26 = _1e.rowIdPrefix + "-" + (_1d ? 1 : 2)
										+ "-" + _22;
								_21.push("<tr id=\"" + _26
										+ "\" datagrid-row-index=\"" + _22
										+ "\" " + cls + " " + _25 + ">");
								_21.push(this.renderRow.call(this, _1a, _20,
										_1d, _22, _1c.rows[j]));
								_21.push("</tr>");
								_22++;
							}
						...
						bindEvents : function(_27) {
							...
							var _2a = ($.data(_29[0], "events") || $._data(
									_29[0], "events")).click[0].handler;
							_29
									.unbind("click")
									.bind(
											"click",
		...
		$.extend(
					$.fn.datagrid.methods,
					{
						expandGroup : function(jq, _3a) {
							return jq
									.each(function() {
										var _3b = $.data(this, "datagrid").dc.view;
										var _3c = _3b
												.find(_3a != undefined ? "div.datagrid-group[group-index=\""
														+ _3a + "\"]"
														: "div.datagrid-group");
										var _3d = _3c
						...
						collapseGroup : function(jq, _3e) {
							return jq
									.each(function() {
										...
										var _40 = _3f
												.find(_3e != undefined ? "div.datagrid-group[group-index=\""
														+ _3e + "\"]"
														: "div.datagrid-group");
										var _41 = _40
												.find("span.datagrid-row-expander");
	...
	$.fn.propertygrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
		...
		groupView : _14,
		groupField : "group",
		groupFormatter : function(_42, _43) {
			return _42;
		}
	});
})(jQuery);
...
(function($) {
	...
	function _31(_32, _33) {
		...
		var _35 = $(_32).datagrid("getColumnFields", true).length
				+ (_34.rownumbers ? 1 : 0);
	...
	function _a1(_a2, _a3) {
		...
		if (_a5) {
			if (_a5.children.length == 0) {
				...
				tr.next("tr.treegrid-tr-tree").remove();
				var _a6 = tr.children("td[field=\"" + _a4.treeField + "\"]")
						.children("div.datagrid-cell");
	...
	$.fn.treegrid = function(_a8, _a9) {
		...
		return this.each(function() {
			...
			if (_ab) {
				...
				_ab = $.data(this, "treegrid", {
					options : $.extend({}, $.fn.treegrid.defaults,
							$.fn.treegrid.parseOptions(this), _a8),
					data : []
				});
			}
			_1(this);
	...
	$.fn.treegrid.methods = {
		...
		reloadFooter : function(jq, _b3) {
			return jq.each(function() {
				...
				if (_b4.showFooter) {
					_b4.view.renderFooter
							.call(_b4.view, this, dc.footer1, true);
					_b4.view.renderFooter.call(_b4.view, this, dc.footer2,
							false);
	...
	$.fn.treegrid.parseOptions = function(_bb) {
		return $.extend({}, $.fn.datagrid.parseOptions(_bb), $.parser
				.parseOptions(_bb, [ "treeField", {
					animate : "boolean"
				} ]));
	};
	var _bc = $
					...
					$.fn.datagrid.defaults.view,
					{
						render : function(_bd, _be, _bf) {
							...
							function _c6(_c7, _c8, _c9) {
								...
								for (var i = 0; i < _c9.length; i++) {
									...
									var css = _c0.rowStyler ? _c0.rowStyler
											.call(_bd, row) : "";
									var _cb = "";
									var _cc = "";
									if (typeof css == "string") {
									...
									var cls = "class=\"datagrid-row "
											+ (_c3++ % 2 && _c0.striped ? "datagrid-row-alt "
													: " ") + _cb + "\"";
									...
									_ca.push("<tr id=\"" + _ce
											...
											+ row[_c0.idField] + "\" " + cls
											+ " " + _cd + ">");
									_ca = _ca.concat(_c4.renderRow.call(_c4,
											_bd, _c1, _c7, _c8, row));
									_ca.push("</tr>");
						...
						renderFooter : function(_cf, _d0, _d1) {
							...
							for (var i = 0; i < _d3.length; i++) {
								var row = _d3[i];
								row[_d2.idField] = row[_d2.idField]
										|| ("foot-row-id" + i);
								_d5
										.push("<tr class=\"datagrid-row\" node-id=\""
												+ row[_d2.idField] + "\">");
								_d5.push(this.renderRow.call(this, _cf, _d4,
										_d1, 0, row));
								_d5.push("</tr>");
							}
						...
						renderRow : function(_d6, _d7, _d8, _d9, row) {
							...
							for (var i = 0; i < _d7.length; i++) {
								var _db = _d7[i];
								var col = $(_d6).datagrid("getColumnOption",
										_db);
								if (col) {
									...
									var cls = _dc ? "class=\"" + _dc + "\""
											: "";
									var _de = col.hidden ? "style=\"display:none;"
											+ _dd + "\""
											: (_dd ? "style=\"" + _dd + "\""
													: "");
									cc.push("<td field=\"" + _db + "\" " + cls
											+ " " + _de + ">");
									if (col.checkbox) {
										var _de = "";
									} else {
						...
						updateRow : function(_e0, id, row) {
							...
							var _e4 = _e1.rowStyler ? _e1.rowStyler.call(_e0,
									_e2) : "";
							function _e5(_e6) {
								var _e7 = $(_e0).treegrid("getColumnFields",
										_e6);
								var tr = _e1.finder.getTr(_e0, id, "body",
										(_e6 ? 1 : 2));
								var _e8 = tr
								...
								var _e9 = tr
										...
										.is(":checked");
								tr
										.html(this.renderRow(_e0, _e7, _e6,
												_e3, _e2));
								tr.attr("style", _e4 || "");
	...
	$.fn.treegrid.defaults = $
			.extend(
					...
					$.fn.datagrid.defaults,
					{
						...
						finder : {
							getTr : function(_105, id, type, _106) {
								type = type || "body";
								_106 = _106 || 0;
								var dc = $.data(_105, "datagrid").dc;
								if (_106 == 0) {
									var opts = $.data(_105, "treegrid").options;
									var tr1 = opts.finder.getTr(_105, id, type,
											1);
									var tr2 = opts.finder.getTr(_105, id, type,
											2);
									return tr1.add(tr2);
								} else {
									if (type == "body") {
										var tr = $("#"
												+ $.data(_105, "datagrid").rowIdPrefix
												+ "-" + _106 + "-" + id);
										if (!tr.length) {
											tr = (_106 == 1 ? dc.body1
													: dc.body2)
										...
										if (type == "footer") {
											return (_106 == 1 ? dc.footer1
													: dc.footer2)
													.find("tr[node-id=\"" + id
															+ "\"]");
										} else {
											if (type == "selected") {
												return (_106 == 1 ? dc.body1
														: dc.body2)
...
(function($) {
	...
	function bindEvents(container) {
		var state = $.data(container, 'tabs')
		var opts = state.options;
		$(container).children('div.tabs-header').unbind().bind(
				'click',
				function(e) {
					if ($(e.target).hasClass('tabs-scroller-left')) {
						...
						if (a.length) {
							...
							if (popts.collapsible) {
								popts.closed ? selectTab(container, index)
										: unselectTab(container, index);
							} else {
				...
				function(e) {
					...
					if (li.length) {
						opts.onContextMenu.call(container, e, li.find(
								'span.tabs-title').html(), getLiIndex(li));
					}
				});
	...
	function addTab(container, options) {
		...
		var pp = $('<div></div>').appendTo(
				$(container).children('div.tabs-panels'));
		tabs.push(pp);
	...
	function updateTab(container, param) {
		...
		if (opts.closable) {
			...
			$('<a href="javascript:void(0)" class="tabs-close"></a>').appendTo(
					tab);
		} else {
		...
		if (opts.tools) {
			var p_tool = $('<span class="tabs-p-tool"></span>').insertAfter(
		...
		if (p) {
			...
			if (!opts.closed) {
				...
				if (opts.closed) {
					...
					state.options.onUnselect.call(container, opts.title,
							getTabIndex(container, p));
				}
			}
		}
	}
	...
	$.fn.tabs.methods = {
		...
		enableTab : function(jq, which) {
			return jq.each(function() {
				$(this).tabs('getTab', which).panel('options').tab
		...
		scrollBy : function(jq, deltaX) { // scroll the tab header by the
			...
			return jq.each(function() {
				...
				var pos = Math.min(wrap._scrollLeft() + deltaX,
						getMaxScrollWidth());
				wrap.animate({
					scrollLeft : pos
				}, opts.scrollDuration);
...
(function($) {
	...
	function _21(_22) {
		...
		_23.panels = [];
		cc.children("div").each(function() {
			var _24 = $.extend({}, $.parser.parseOptions(this), {
				selected : ($(this).attr("selected") ? true : undefined)
			});
			var pp = $(this);
			_23.panels.push(pp);
	...
	function _27(_28, pp, _29) {
						...
						.extend(
								...
								_29,
								{
									onBeforeExpand : function() {
										...
										_2b
												.addClass("accordion-header-selected");
										_2b
									...
									onExpand : function() {
										...
										_2a.onSelect.call(_28, $(this).panel(
												"options").title,
												_17(_28, this));
									},
									onBeforeCollapse : function() {
									...
									onCollapse : function() {
										...
										_2a.onUnselect.call(_28, $(this).panel(
												"options").title,
												_17(_28, this));
									}
								}));
		...
		var t = $("<a href=\"javascript:void(0)\"></a>").addClass(
				"accordion-collapse accordion-expand").appendTo(_2e);
			...
			if (_52) {
				...
				$.data(this, "accordion", {
					options : $.extend({}, $.fn.accordion.defaults,
							$.fn.accordion.parseOptions(this), _50),
	...
	$.fn.accordion.parseOptions = function(_59) {
		var t = $(_59);
		return $.extend({}, $.parser.parseOptions(_59, [ "width", "height", {
			fit : "boolean",
			border : "boolean",
			animate : "boolean",
			multiple : "boolean",
...
(function($) {
	...
	function _b(_c) {
		...
		var _e = $("<div class=\"messager-body\"></div>").html(_d.msg)
				.appendTo("body");
		_e.window(_d);
	...
	function _f(_10, _11, _12) {
		...
		if (_12) {
			...
			for ( var _13 in _12) {
				$("<a></a>").attr("href", "javascript:void(0)").text(_13).css(
						"margin-left", 10).bind("click", eval(_12[_13]))
...
(function($) {
	...
	function _9(_a, _b) {
		...
		if (_d.inline) {
			...
			_d.left = ($(window)._outerWidth() - _e) / 2
					+ $(document).scrollLeft();
		}
		if (_b) {
			_5(_a);
	...
	function _10(_11, _12) {
		...
		if (_14.inline) {
			...
			_14.top = ($(window)._outerHeight() - _15) / 2
					+ $(document).scrollTop();
		}
		if (_12) {
			_5(_11);
	...
	function _17(_18) {
		...
		var win = $(_18).panel(
				$.extend({}, _19.options, {
					...
					bodyCls : "window-body "
							+ (_19.options.noheader ? "window-body-noheader"
									: ""),
					onBeforeDestroy : function() {
					...
					onOpen : function() {
						...
						_19.window
								.css("z-index", $.fn.window.defaults.zIndex++);
		...
		if (_19.options.modal == true) {
			_19.mask = $("<div class=\"window-mask\"></div>").insertAfter(
					_19.window);
			_19.mask.css({
				width : (_19.options.inline ? _19.mask.parent().width()
						: _1d().width),
				height : (_19.options.inline ? _19.mask.parent().height()
						: _1d().height),
				display : "none"
			});
		}
		...
		if (_19.options.shadow == true) {
			_19.shadow = $("<div class=\"window-shadow\"></div>").insertAfter(
					_19.window);
			_19.shadow.css({
				display : "none"
			});
	...
	function _1e(_1f) {
		...
		_20.window.draggable({
			...
			onStartDrag : function(e) {
				...
				if (!_20.proxy) {
					_20.proxy = $("<div class=\"window-proxy\"></div>")
							.insertAfter(_20.window);
				}
				_20.proxy.css({
					display : "none",
					zIndex : $.fn.window.defaults.zIndex++,
		...
		_20.window.resizable({
			disabled : _20.options.resizable == false,
			onStartResize : function(e) {
				_20.pmask = $("<div class=\"window-proxy-mask\"></div>")
						.insertAfter(_20.window);
				_20.pmask.css({
					zIndex : $.fn.window.defaults.zIndex++,
					left : e.data.left,
	...
	$.fn.window.parseOptions = function(_29) {
		return $.extend({}, $.fn.panel.parseOptions(_29), $.parser
				.parseOptions(_29, [ {
					draggable : "boolean",
					resizable : "boolean",
					shadow : "boolean",
...
(function($) {
		...
		if (_6.buttons) {
			if ($.isArray(_6.buttons)) {
				...
				for (var i = 0; i < _6.buttons.length; i++) {
					var p = _6.buttons[i];
					var _c = $("<a href=\"javascript:void(0)\"></a>").appendTo(
							_b);
					if (p.handler) {
		...
		$(_5).window(
				$.extend({}, _6, {
					...
					onResize : function(_f, _10) {
						...
						_7.panel("resize", {
							width : _11.width(),
							height : (_10 == "auto") ? "auto" : _11.height()
									- _11.children("div.dialog-toolbar")
											._outerHeight()
									- _11.children("div.dialog-button")
											._outerHeight()
						});
						if (_6.onResize) {
	...
	$.fn.dialog.parseOptions = function(_1e) {
		return $.extend({}, $.fn.window.parseOptions(_1e), $.parser
				.parseOptions(_1e, [ "toolbar", "buttons" ]));
	};
...
(function($) {
	function _1(_2, _3) {
		...
		var _7 = $("<iframe id=" + _6 + " name=" + _6 + "></iframe>").attr(
				"src",
	...
	function _f(_10, _11) {
		...
		function _19(_1d, val) {
			var rr = $(_10).find(
					"input[name=\"" + _1d + "\"][type=radio], input[name=\""
							+ _1d + "\"][type=checkbox]");
	...
	function _29(_2a) {
		_2a.reset();
		var t = $(_2a);
		var _2b = [ "combo", "combobox", "combotree", "combogrid", "datebox",
	...
	function _33(_34, _35) {
		$(_34).find(".validatebox-text:not(:disabled)").validatebox(
				_35 ? "disableValidation" : "enableValidation");
	}
	;
	$.fn.form = function(_36, _37) {
		...
		return this.each(function() {
			if (!$.data(this, "form")) {
				$.data(this, "form", {
					options : $.extend({}, $.fn.form.defaults, _36)
				});
			}
			_2d(this);
		});
...
(function($) {
	...
	$.fn.district = function(options, param) {
		...
		return this.each(function() {
			...
			if (opt) {
				...
				$.data(_this, "district", {
					options : $.extend({}, $.fn.district.defaults,
							$.fn.district.parseOptions(_this), options)
				});
				creatDistrict(_this);
			}
		});
	...
	$.fn.district.parseOptions = function(target) {
		return $.extend({}, $.parser.parseOptions(target, [ 'level' ]));
	};
...
(function($) {
	function createInputFile(target) {
		if ($(target).hasClass('jqfile'))
			return;
		var w = $(target).width();
		var wrapper = $("<div>").addClass('file-button')
		var filename = $('<input class="ipt">').addClass(
		...
		// style="margin-left:2px;"><span>浏览</span></a>');
		$(target).wrap(wrapper);
		$(target).css({
			"float" : "left",
			"position" : "relative",
		...
		return this.each(function() {
			...
			if (opt) {
				...
				$.data(_this, "inputfile", {
					options : $.extend({}, $.fn.inputfile.defaults,
							$.fn.inputfile.parseOptions(_this), options)
				});
	...
	_extend(
			KCmd,
			{
				...
				forecolor : function(val) {
					return this.toggle('<span style="color:' + val
							+ ';"></span>', {
						span : '.color=' + val,
						font : 'color'
					});
				...
				fontsize : function(val) {
					return this.toggle('<span style="font-size:' + val
							+ ';"></span>', {
						span : '.font-size=' + val,
						font : 'size'
					});
				...
				fontfamily : function(val) {
					return this.toggle('<span style="font-family:' + val
							+ ';"></span>', {
				...
				createlink : function(url, type) {
					...
					K('a[href="__kindeditor_temp_url__"]', doc).each(
							function() {
								K(this).attr('href', url).attr('data-ke-src',
										url);
								if (type) {
	...
	_extend(
			...
			KWidget,
			{
				...
				showLoading : function(msg) {
					...
					self.loading = K(
							'<div class="ke-dialog-loading"><div class="ke-inline-block ke-dialog-loading-content" >'
...
(function($) {
	$.fn.editor = function(options, params) {
		...
		return this.each(function() {
			...
			if (data) {
				...
				newOptions = $.extend({}, $.fn.editor.defaults, $.fn.editor
						.parseOptions(this), options);
				$.data(this, "editor", {
					options : newOptions
				});
	...
	$.fn.editor.parseOptions = function(target) {
		return $.extend({}, $.parser.parseOptions(target, [ "width", "height",
				"designMode", "resizeType" ]));
	};
	$.fn.editor.defaults = {
		basePath : bootPATH + 'assets/js/libs/kindeditor/',
		allowPreviewEmoticons : false,
		filterMode : true,
		imageUploadJson : bootPATH
				+ 'assets/js/libs/kindeditor/php/upload_json.php',
		resizeType : 1,
		...
		htmlTags : {
			...
			table : [ 'class', 'border', 'cellspacing', 'cellpadding', 'width',
					'height', 'align', 'style' ],
			...
			embed : [ 'src', 'width', 'height', 'type', 'loop', 'autostart',
					'quality', 'style', 'align', 'allowscriptaccess', '/' ],
...
(function($) {
	...
	function init(target) {
		...
		var _div = $('<div>').addClass("ipt-search-box").width(
				_width + _offsetWidth);
		var _i = $('<i>');
		...
		return this.each(function() {
			...
			if (opt) {
				...
				$.data(_this, "iptsearch", {
					options : $.extend({}, $.fn.iptsearch.defaults,
							$.fn.iptsearch.parseOptions(_this), options)
				});
				init(_this);
			}
		});
...
(function($, undefined) {
	...
	// easyui-panel、easyui-window、easyui-dialog 卸载时回收内存，主要用于
	// layout、panel(及其继承组件) 使用 iframe 嵌入网页时的内存泄漏问题
	var onBeforeDestroy = function() {
		$("iframe,frame", this).each(
				function() {
					try {
	...
	var onResize = function(width, height) {
		var p = $.util.parseJquery(this), isWin = p.panel("isWindow"), isDia = p
				.panel("isDialog"), plugin = isDia ? "dialog"
				: (isWin ? "window" : "panel"), _onResizeFn = _onResize[plugin];
		if ($.isFunction(_onResizeFn)) {
			_onResizeFn.apply(this, arguments);
		}
		if (!p.panel("inLayout")) {
			var opts = p.panel("options");
			opts.minWidth = $.isNumeric(opts.minWidth) ? opts.minWidth
					: defaults.minHeight;
			opts.maxWidth = $.isNumeric(opts.maxWidth) ? opts.maxWidth
					: defaults.maxWidth;
			opts.minHeight = $.isNumeric(opts.minHeight) ? opts.minHeight
					: defaults.minHeight;
			opts.maxHeight = $.isNumeric(opts.maxHeight) ? opts.maxHeight
					: defaults.maxHeight;
			var resizable = false;
	...
	var onMove = function(left, top) {
		var p = $.util.parseJquery(this), isWin = p.panel("isWindow"), isDia = p
				.panel("isDialog"), plugin = isDia ? "dialog"
				: (isWin ? "window" : "panel"), _onMoveFn = _onMove[plugin], opts = p
				.panel("options");
		if ($.isFunction(_onMoveFn)) {
			_onMoveFn.apply(this, arguments);
		}
		if (opts.maximized) {
			return p[plugin]("restore");
		}
		if (!opts.inContainer) {
			return;
		}
		var panel = p.panel("panel"), parent = panel.parent(), isRoot = parent
				.is("body"), scope = $.extend({}, isRoot ? $.util.windowSize()
				: {
					width : parent.innerWidth(),
					height : parent.innerHeight()
				}), width = $.isNumeric(opts.width) ? opts.width : panel
				.outerWidth(), height = $.isNumeric(opts.height) ? opts.height
				: panel.outerHeight(), moveable = false;
		if (left < 0) {
			left = 0;
			moveable = true;
		}
	...
	var inLayout = function(target) {
		var t = $.util.parseJquery(target), body = t.panel("body"), panel = t
				.panel("panel");
		return body.hasClass("layout-body") && panel.hasClass("layout-panel");
	};

	var inTabs = function(target) {
		var t = $.util.parseJquery(target), panel = t.panel("panel"), panels = panel
				.parent(), container = panels.parent();
		return panels.hasClass("tabs-panels")
				&& container.hasClass("tabs-container");
	};

	var inAccordion = function(target) {
		var t = $.util.parseJquery(target), panel = t.panel("panel"), container = panel
				.parent();
		return (container.hasClass("accordion") && $.data(container[0],
	...
	var isDialog = function(target) {
		...
		return isWindow(target)
				&& (body.children("div.panel").children(
						"div.panel-body.dialog-content").length ? true : false);
	};

	function parseExtensionsBegin(options) {
		options._extensionsPanel = {
			href : options.href,
	...
	function parseExtensionsEnd(target) {
		var panel = $(target), opts = panel.panel("options"), exts = opts._extensionsPanel ? opts._extensionsPanel
				: opts._extensionsPanel = {
					href : opts.href,
					content : opts.content
				};
		opts.href = exts.href;
		opts.content = exts.content;
		if (opts.plain || opts.fieldset) {
			...
			$('div.panel-header:first', pp).append(
	...
	function init(target) {
		...
		opts.plain = exts.plain;
		opts.fieldset = exts.fieldset;
	...
	$.fn.panel = function(options, param) {
		...
		options = options || {};
		return this.each(function() {
			var jq = $.util.parseJquery(this), opts = $.extend({}, $.fn.panel
					.parseOptions(this), options);
			if (opts.plain || opts.fieldset) {
	...
	function refresh(target, href) {
		...
		if (opts.iniframe) {
			var exts = opts._extensionsPanel ? opts._extensionsPanel
					: opts._extensionsPanel = {
						href : opts.href,
						content : opts.content
					};
			exts.href = opts.href;
			exts.content = opts.content;
			opts.href = null;
	...
	function getIframe(target) {
		...
		var mask = $(
				...
				.appendTo(body);
		var msg = $(
				"<div class=\"datagrid-mask-msg\" style=\"display:none; left: 50%;\"></div>")
				.html(loadMsg).appendTo(body);
	...
	function getHeader(target) {
		...
		if (!inTabs(target)) {
			return _header.call(t, t);
		}
		var panel = t.panel("panel"), index = panel.index(), tabs = panel
	...
	function setTitle(target, title) {
		var t = $.util.parseJquery(target);
		if (!inTabs(target)) {
			return _setTitle.call(t, t, title);
		}
		if (!title) {
			return;
		}
	...
	var methods = $.fn.panel.extensions.methods = {
		...
		inLayout : function(jq) {
			return inLayout(jq[0]);
		},
		...
		inAccordion : function(jq) {
			return inAccordion(jq[0]);
		},

		// 判断当前 easyui-panel 是否为 easyui-window 组件；
		isWindow : function(jq) {
			return isWindow(jq[0]);
		},

		// 判断当前 easyui-panel 是否为 easyui-dialog 组件；
		isDialog : function(jq) {
			return isDialog(jq[0]);
		},

		// 增加 easyui-panel 控件的扩展方法；该方法用于获取当前在 iniframe: true 时当前 panel 控件中的
		// iframe 容器对象；
		// 备注：如果 inirame: false，则该方法返回一个空的 jQuery 对象。
		iframe : function(jq) {
			return getIframe(jq[0]);
		},
		...
		// 重写 easyui-panel 控件的 header 方法，支持位于 easyui-tabs 中的 tab-panel 部件获取
		// header 对象；
		// 备注：如果该 panel 位于 easyui-tabs 中，则该方法返回 easyui-tabs 的 div.tabs-header
		// div.tabs-wrap ul.tabs 中对应该 tab-panel 的 li 对象。
		header : function(jq) {
			return getHeader(jq[0]);
		},

		// 重写 easyui-panel 控件的 setTitle 方法，支持位于 easyui-tabs 中的 tab-panel 部件设置
		// title 操作；
	...
	var defaults = $.fn.panel.extensions.defaults = {
		...
		// 增加 easyui-panel 控件的自定义属性，重新定义的 onResize 事件。用于扩展四个新增属性
		// minWidth、maxWidth、minHeight、maxHeight 的功能。
		onResize : onResize,

		// 扩展 easyui-panel、easyui-window 以及 easyui-dialog
		// 控件的自定义属性，表示该窗口是否无法移除父级对象边界，默认为 true。
		inContainer : true,

		// 重写 easyui-panel、easyui-window 以及 easyui-dialog 控件的原生事件
		// onMove，以支持相应扩展功能。
		onMove : onMove
	};
	...
	var css = "iframe.panel-iframe { margin: 0px; padding: 0px; width: 100%; height: 100%; border: 0px; overflow: auto; }"
	$.util.addCss(css);
...
(function($, undefined) {
	...
	/*
	 * $.extend($.fn.layout.defaults, {show:true}); var _layout = $.fn.layout;
	 * $.fn.layout = function (options, param) { if (typeof options == "string") {
	 * return _layout.apply(this, arguments); } return _layout.apply(this,
	 * arguments).each(function () { initialize(this); }); };
...
(function($) {
	function addCss(id, content) {
		if ($('#' + id).length > 0)
			return;
		return $('<style>' + content + '</style>').attr('id', id).attr('type',
			...
			.extend({
				mask : function(opts) {
					...
					if (options.target != 'body'
							&& $(options.target).css('position') == 'static') {
					...
					var msg = $(
							"<div class=\"datagrid-mask-msg\" style=\"display:none; left: 50%;\"></div>")
							.html(options.loadMsg).appendTo(options.target);
					setTimeout(function() {
						msg.css("marginLeft", -msg.outerWidth() / 2).show();
					}, 5);
...
(function($, undefined) {
	...
	function initTabsPanelPaddingTopLine(target) {
		...
		if ($.isNumeric(opts.lineHeight) && opts.lineHeight > 0) {
			if (!$.array.contains([ "top", "bottom", "left", "right" ],
					position)) {
				position = "top";
			}
			tabs.children("div.tabs-panels").css("padding-" + position,
					opts.lineHeight.toString() + "px").children().children()
					.css("border-" + position + "-width", "1px");
		}
	}

	var _onContextMenu = $.fn.tabs.defaults.onContextMenu;
	var onContextMenu = function(e, title, index) {
		if ($.isFunction(_onContextMenu)) {
			_onContextMenu.apply(this, arguments);
		}
		var t = $.util.parseJquery(this), opts = t.tabs("options");
		if (opts.enableConextMenu) {
			e.preventDefault();
			var panel = t.tabs("getTab", index), panelOpts = panel
					.panel("options"), leftTabs = t.tabs("leftClosableTabs",
					index), rightTabs = t.tabs("rightClosableTabs", index), otherTabs = t
					.tabs("otherClosableTabs", index), allTabs = t
					.tabs("closableTabs"), selected = t.tabs("isSelected",
					index), m1 = {
				text : "显示选项卡的 option",
				iconCls : "icon-standard-application-form",
				disabled : !opts.showOption,
				handler : function() {
					t.tabs("showOption", index);
				}
			}, m2 = {
				text : "关闭选项卡",
				iconCls : "icon-standard-application-form-delete",
				disabled : !panelOpts.closable,
				handler : function() {
					t.tabs("closeClosable", index);
				}
			}, m3 = {
				text : "关闭其他选项卡",
				iconCls : "icon-standard-cancel",
				disabled : !otherTabs.length,
				handler : function() {
					t.tabs("closeOtherClosable", index);
				}
			}, m4 = {
				text : "刷新选项卡",
				iconCls : "icon-standard-table-refresh",
				disabled : !panelOpts.refreshable,
				handler : function() {
				...
				disabled : !leftTabs.length,
				handler : function() {
					t.tabs("closeLeftClosable", index);
				}
			}, m6 = {
				text : "关闭右侧选项卡",
				...
				handler : function() {
					t.tabs("closeRightClosable", index);
				}
			}, m7 = {
				text : "关闭所有选项卡",
				...
				handler : function() {
					t.tabs("closeAllClosable");
				}
			}, m8 = {
				text : "新建选项卡",
				iconCls : "icon-standard-tab-add",
				disabled : !opts.enableNewTabMenu,
				handler : function() {
					t.tabs("newTab", index);
				}
			}, m9 = {
				...
				disabled : !panelOpts.repeatable,
				handler : function() {
					t.tabs("repeat", index);
				}
			};
			var items = [];
			if ($.array.likeArray(opts.contextMenu)
					&& !$.util.isString(opts.contextMenu)) {
				$.array.merge(items, opts.contextMenu);
			}
			if (opts.showOption) {
				$.array.merge(items, "-", m1);
			}
			$.array.merge(items, panelOpts.closable ? [ "-", m2, m3 ] : [ "-",
					m3 ]);
			if (panelOpts.refreshable) {
				$.array.merge(items, "-", m4);
			}
			$.array.merge(items, "-", m5, m6, m7);
			if (panelOpts.repeatable || opts.enableNewTabMenu) {
				var mm = [];
				if (opts.enableNewTabMenu) {
					mm.push(m8);
				}
				if (panelOpts.repeatable) {
					mm.push(m9);
				}
		...
		return $.array
				.map(
						...
						function(value) {
							...
							ret.id = $.isFunction(value.id) ? value.id.call(
									ret, e, title, index, tabs) : value.id;
							ret.text = $.isFunction(value.text) ? value.text
									.call(ret, e, title, index, tabs)
									: value.text;
							ret.iconCls = $.isFunction(value.iconCls) ? value.iconCls
									.call(ret, e, title, index, tabs)
									: value.iconCls;
							ret.disabled = $.isFunction(value.disabled) ? value.disabled
									.call(ret, e, title, index, tabs)
									: value.disabled;
							ret.hideOnClick = $.isFunction(value.hideOnClick) ? value.hideOnClick
									.call(ret, e, title, index, tabs)
									: value.hideOnClick;
							ret.onclick = $.isFunction(value.onclick) ? function(
									e, item, menu) {
								value.onclick.call(this, e, title, index, tabs,
										item, menu);
							}
									: value.onclick;
							ret.handler = $.isFunction(value.handler) ? function(
									e, item, menu) {
								value.handler.call(this, e, title, index, tabs,
										item, menu);
							}
									: value.handler;
							if (ret.children && ret.children.length) {
								ret.children = parseContextMenuMap(e, title,
										index, ret.children, tabs);
							}
							return ret;
						});
	}
	...
	function updateTab(target, param) {
		...
		var tabs = $.util.parseJquery(target), opts = tabs.tabs("options"), index = tabs
				.tabs("getTabIndex", param.tab), panelOpts = $.union({},
				param.options, $.fn.tabs.extensions.panelOptions), tools = panelOpts.tools, onLoad = panelOpts.onLoad, refreshButton = {
			iconCls : "icon-mini-refresh",
			handler : function() {
				var title = $(this).parent().prev().find("span.tabs-title")
						.text();
				if (title) {
					$.util.exec(function() {
						tabs.tabs("refresh", title);
					});
				}
			}
		};
		if (panelOpts.refreshable && panelOpts.refreshButton) {
			if ($.array.likeArray(panelOpts.tools)) {
				panelOpts.tools = $.array.merge([], panelOpts.tools,
						refreshButton);
			} else {
		...
		if ((!$.string.isNullOrWhiteSpace(panelOpts.href) || !$.string
				.isNullOrWhiteSpace(panelOpts.content))
				&& (panelOpts.selected || tabs.tabs("getSelected") == param.tab)
				&& !panelOpts.iniframe) {
		...
		var ret = _updateTab.call(tabs, tabs, {
			tab : param.tab,
			options : panelOpts
		});
		...
		var li = tabs.find(">div.tabs-header>div.tabs-wrap>ul.tabs>li").eq(
				index).off("dblclick.closeOnDblClick").on(
				"dblclick.closeOnDblClick", function() {
					if (panelOpts.closeOnDblClick && panelOpts.closable) {
						tabs.tabs("close", panelOpts.title);
					}
				});
		if (panelOpts.closeOnDblClick && panelOpts.closable) {
			li.attr("title", "双击此选项卡标题可以将其关闭");
		}
		return ret;
	}
	;
	...
	function refreshTab(target, which) {
		var tabs = $.util.parseJquery(target), opts = tabs.tabs("options"), panel = tabs
				.tabs("getTab", which), panelOpts = panel.panel("options"), index = tabs
				.tabs("getTabIndex", panel);
		if ($.string.isNullOrWhiteSpace(panelOpts.href)
				&& $.string.isNullOrWhiteSpace(panelOpts.content)) {
	...
	function isSelected(target, which) {
		var tabs = $.util.parseJquery(target), selected = tabs
				.tabs("getSelected"), index = tabs
				.tabs("getTabIndex", selected);
		var thisTab = tabs.tabs("getTab", which), thisIndex = tabs.tabs(
				"getTabIndex", thisTab);
	...
	function isClosable(target, which) {
		var tabs = $.util.parseJquery(target), panel = tabs.tabs("getTab",
				which), panelOpts = panel.panel("options");
		return panelOpts.closable;
	}
	;

	function newTab(target, which) {
		var content = $("<table></table>").css({
			width : "95%",
			height : "100%"
		}), txtTitle = $("<input type='text' style='width: 98%;'/>"), txtHref = $("<input type='text' style='width: 98%;'/>"), ckRefreshable = $("<input id='refreshable' type='checkbox' checked='true' />"), ckIniframe = $("<input id='iniframe' type='checkbox' />"), lblRefreshable = $("<label>是否可刷新</label>"), lblIniframe = $("<label>是否嵌至 IFRAME(浏览器内部窗体) 中</label>");

		var tr1 = $("<tr></tr>").append(
				"<td width='24%' align='right'>选项卡标题：</td>").appendTo(content);
		var tr2 = $("<tr></tr>").append(
				"<td width='24%' align='right'>路径(href)：</td>").appendTo(
				content);
		var tr3 = $("<tr></tr>").appendTo(content);
		$("<td></td>").append(txtTitle).appendTo(tr1);
		$("<td></td>").append(txtHref).appendTo(tr2);
		$("<td width='24%' align='right'></td>").append(ckRefreshable).append(
				lblRefreshable).appendTo(tr3);
		$("<td align='right'></td>").append(ckIniframe).append(lblIniframe)
				.appendTo(tr3);

		which = which || 0;
		var tabs = $.util.parseJquery(target), index = $.isNumeric(which) ? which
				: tabs.tabs("getTabIndex", tabs.tabs("getTab", which)), header = tabs
				.find(">div.tabs-header>div.tabs-wrap>ul.tabs>li:eq(" + index
						+ ")"), offset = header.offset(), position = $.extend(
				{}, {
					left : offset.left + 10,
					top : offset.top + 10
				});
				...
				.extend(
						{
							...
							onApply : function(dia) {
								var title = txtTitle.val(), href = txtHref
										.val();
								href = href
										|| $.fn.tabs.extensions.panelOptions.href;
								if ($.string.isNullOrWhiteSpace(title)) {
									title = "新建选项卡";
								}
								var i = 0;
								while (tabs.tabs("getTab", title = title
										+ (i ? i : ""))) {
									i++;
								}
								if ($.string.isNullOrWhiteSpace(href)) {
									$.easyui.messager.show("操作提醒",
											"请输入要创建的选项卡的路径！", "info");
									txtHref.focus();
									return;
								}
								var iniframe = ckIniframe.prop("checked"), refreshable = ckRefreshable
										.prop("checked");
								tabs.tabs("add", {
									title : title,
									href : href,
	...
	function repeatTab(target, which) {
		var tabs = $.util.parseJquery(target), panel = tabs.tabs("getTab",
				which), panelOpts = panel.panel("options");
		var opts = $.extend({}, panelOpts, {
			selected : true,
			closable : true
		}), i = 2, title = opts.title;
		while (tabs.tabs("getTab", opts.title = title + "-" + i.toString())) {
			i++;
		}
		tabs.tabs("add", opts);
	}
	...
	function getTabOption(target, which) {
		var t = $.util.parseJquery(target), tab = tabs.tabs("getTab", which), tabOpts = tab
				.panel("options");
		return tabOpts;
	}
	;
	...
	function getSelectedOption(target) {
		var t = $.util.parseJquery(target), tab = t.tabs("getSelected"), tabOpts = tab
				.panel("options");
		return tabOpts;
	}
	;
	...
	function getSelectedIndex(target) {
		var t = $.util.parseJquery(target), tab = t.tabs("getSelected"), index = t
	...
	function getSelectedTitle(target) {
		var t = $.util.parseJquery(target), tabOpts = t
				.tabs("getSelectedOption"), title = tabOpts.title;
		return title;
	}
	;
	...
	function leftTabs(target, which) {
		var tabs = $.util.parseJquery(target), index = $.isNumeric(which) ? which
				: tabs.tabs("getTabIndex", tabs.tabs("getTab", which)), panels = tabs
				.tabs("tabs");
	...
	function otherTabs(target, which) {
		var tabs = $.util.parseJquery(target), index = $.isNumeric(which) ? which
				: tabs.tabs("getTabIndex", tabs.tabs("getTab", which)), panels = tabs
				.tabs("tabs");
		return $.array.merge($.array.range(panels, 0, index), $.array.range(
				panels, index + 1));
	}
	;
	...
	function leftClosableTabs(target, which) {
		var tabs = $.util.parseJquery(target), panels = tabs.tabs("leftTabs",
				which);
		return $.array.filter(panels, closableFinder);
	}
	;
	...
	function rightClosableTabs(target, which) {
		var tabs = $.util.parseJquery(target), panels = tabs.tabs("rightTabs",
				which);
		return $.array.filter(panels, closableFinder);
	}
	;
	...
	function otherClosableTabs(target, which) {
		var tabs = $.util.parseJquery(target), panels = tabs.tabs("otherTabs",
				which);
		return $.array.filter(panels, closableFinder);
	}
	;
	...
	function closeLeftTabs(target, which) {
		...
		$.each(panels, function() {
			tabs.tabs("close", tabs.tabs("getTabIndex", this));
		});
	}
	;
	...
	function closeClosableTab(target, which) {
		...
		if (panel && panel.panel("options").closable) {
			var index = $.isNumeric(which) ? which : tabs.tabs("getTabIndex",
					panel);
	...
	function closeLeftClosableTabs(target, which) {
		var tabs = $.util.parseJquery(target), panels = tabs.tabs(
				"leftClosableTabs", which);
		$.each($.array.clone(panels), function() {
			tabs.tabs("close", tabs.tabs("getTabIndex", this));
		});
	}
	...
	function showOption(target, which) {
		...
		var tabs = $.util.parseJquery(target), panel = tabs.tabs("getTab",
				which), panelOpts = panel.panel("options");
		var index = $.isNumeric(which) ? which : tabs
				.tabs("getTabIndex", panel), header = tabs
				.find(">div.tabs-header>div.tabs-wrap>ul.tabs>li:eq(" + index
						+ ")"), offset = header.offset(), position = $.extend(
				{}, {
					left : offset.left + 10,
		...
		$.easyui.showOption(panelOpts, {
			iconCls : "icon-standard-application-form",
			title : "显示选项卡 " + panelOpts.title + " 的 option 值",
			left : position.left,
			top : position.top,
			topMost : false
		});
	...
	function moveTab(tabTarget, param) {
		if (!param || param.source == undefined || param.target == undefined
				|| !param.point) {
			return;
		}
		var source = param.source, target = param.target, point = $.array
				.contains([ "before", "after" ], param.point) ? param.point
				: "before", t = $.util.parseJquery(tabTarget), tabs = t
				.tabs("tabs"), sourcePanel = t.tabs("getTab", source), targetPanel = t
				.tabs("getTab", target), sourceIndex = t.tabs("getTabIndex",
				sourcePanel), sourceHeader = sourcePanel.panel("header"), targetHeader = targetPanel
				.panel("header");
		...
		$.array.insert(tabs, point == "before" ? targetIndex : targetIndex + 1,
				sourcePanel);

		sourcePanel = sourcePanel.panel("panel");
		targetPanel = targetPanel.panel("panel");
	...
	function setTitle(target, param) {
		if (!param || !(param.which || $.isNumeric(param.which))
				|| !param.title) {
			return;
		}
	...
	var methods = $.fn.tabs.extensions.methods = {
		...
		repeat : function(jq, which) {
			return jq.each(function() {
				repeatTab(this, which);
			});
		},

		// 获取指定选项卡的属性值集合(option)；
		getTabOption : function(jq, which) {
			return getTabOption(jq[0], which);
		},

		// 获取当前选中的选项卡的属性值集合 (option)；
		getSelectedOption : function(jq) {
			return getSelectedOption(jq[0]);
		},
		...
		// 获取当前选中的选项卡的标题。
		getSelectedTitle : function(jq) {
			return getSelectedTitle(jq[0]);
		},
		...
		leftTabs : function(jq, which) {
			return leftTabs(jq[0], which);
		},
		...
		rightTabs : function(jq, which) {
			return rightTabs(jq[0], which);
		},
		...
		otherTabs : function(jq, which) {
			return otherTabs(jq[0], which);
		},
		...
		closableTabs : function(jq) {
			return closableTabs(jq[0]);
		},
		...
		leftClosableTabs : function(jq, which) {
			return leftClosableTabs(jq[0], which);
		},
		...
		rightClosableTabs : function(jq, which) {
			return rightClosableTabs(jq[0], which);
		},
		...
		otherClosableTabs : function(jq, which) {
			return otherClosableTabs(jq[0], which);
		},
		...
		// which: 指定的选项卡的 索引号 或者 标题。
		// 返回值：返回当前选项卡控件 easyui-tabs 的 jQuery 对象。
		closeOther : function(jq, which) {
			return jq.each(function() {
				closeOtherTabs(this, which);
			});
		},
		...
		closeLeftClosable : function(jq, which) {
			return jq.each(function() {
				closeLeftClosableTabs(this, which);
			});
		},
		...
		closeRightClosable : function(jq, which) {
			return jq.each(function() {
				closeRightClosableTabs(this, which);
			});
		},
		...
		// which: 指定的选项卡的 索引号 或者 标题。
		// 返回值：返回当前选项卡控件 easyui-tabs 的 jQuery 对象。
		closeOtherClosable : function(jq, which) {
			return jq.each(function() {
				closeOtherClosableTabs(this, which);
			});
		},
		...
		closeAllClosable : function(jq) {
			return jq.each(function() {
				closeAllClosableTabs(this);
			});
		},

		// 以 easyui-dialog 的方式弹出一个 dialog
		// 对话框窗体，该窗体中显示指定选项卡的所有属性值(options)；该方法定义如下参数：
		// which: 指定的选项卡的 索引号 或者 标题。
		// 返回值：返回当前选项卡控件 easyui-tabs 的 jQuery 对象。
		showOption : function(jq, which) {
			return jq.each(function() {
				showOption(this, which);
			});
		},
		...
		// 返回值：返回当前选项卡控件 easyui-tabs 的 jQuery 对象。
		insert : function(jq, options) {
			return jq.each(function() {
				insertTab(this, options);
			});
		},
	...
	var defaults = $.fn.tabs.extensions.defaults = {
		// 增加 easyui-tabs 的自定义扩展属性，该属性表示当前选项卡标题栏和选项卡的 pane-body
		// 之间的空白区域高(宽)度(px)；
		...
		// handler: 表示菜单项的点击事件，该事件函数格式为 function(e, title, index, tabs, item,
		// menu)，其中 this 指向菜单项本身
		contextMenu : null,
	...
	function closeCurrentTab(target, iniframe) {
		...
		var current = $.util.parseJquery(target), currentTabs = current
				.currentTabs(), index;
		if (!iniframe && currentTabs.length) {
			index = current.currentTabIndex();
			if (index > -1) {
				currentTabs.tabs("close", index);
			}
		} else {
			var jq = $.util.parent.$;
	...
	$.fn.extend({
		// 扩展 jQuery 对象的实例方法；用于关闭当前对象所在的 easyui-tabs 当前选项卡(支持当前选项卡页面为 iframe
		// 加载的情况)。
		// 该方法定义如下参数：
		// iniframe: Boolean 类型值，表示是否为关闭当前对象所在的父级页面的选项卡；默认为 false。
		// 如果当前页面为顶级页面，
		// 或者当前对象在 iframe 中但是不在当前iframe中的某个 easyui-tabs 内，则参数参数 inframe 无效。
		// 返回值：返回当前 jQuery 链式对象(实际上返回的 jQuery 对象中，所包含的元素已经被销毁，因为其容器 tab-panel
		// 被关闭销毁了)。
		closeCurrentTab : function(iniframe) {
			return this.each(function() {
				closeCurrentTab(this, iniframe);
			});
		}
	});
...
(function($, undefined) {
	...
	var submit = function(target, options) {
		...
		if (/^(?:form)$/i.test(this.nodeName)) {
			return _submit.call(form, form, options);
		}
		var opts = $.extend({}, $.fn.form.defaults, options || {});
		if (opts.onSubmit && opts.onSubmit.call(target, param) == false) {
			return;
		}
		if (!opts.url) {
			return;
		...
		$.post(opts.url, param, function(data) {
			if (opts.success) {
				opts.success(data);
			}
		});
	...
	var load = function(target, data) {
		...
		function _checkField(name, val) {
			var rr = form.find('input[name="' + name
	...
	var methods = $.fn.form.extensions.methods = {
		...
		// onlyEnabled: 表示返回的结果数据中是否仅包含启用(disabled == false)的 HTML 表单控件；Boolean
		// 类型值，默认为 false。
		...
		// 这是一个 String 类型值，默认为 ","；当 transcript 的值定义为 "overlay" 且 overtype 的值定义为
		// "append" 时，此属性方有效。
		...
		getData : function(jq, param) {
			return getData(jq[0], param);
		},

		isChanged : function(jq) {
			return isChanged(jq[0]);
		},

		// 重写 easyui-form 控件的 submit 方法，使之除了支持 form 标签提交外，还支持 div 等其他容器标签的提交。
		// submit: function (jq, options) { return jq.each(function () {
		// submit(this, options); }); },
	...
	$.fn.form.comboList = [ 'combobox', 'combotree', 'combogrid',
			'datetimebox', 'datebox', 'combo' ];
})(jQuery);
...
(function($, undefined) {
	...
	var rules = {
		...
		minLength : {
			validator : function(value, param) {
				return rules.length.validator(value, [ param[0] ]);
			},
			message : "最少输入 {0} 个字符."
		},
		// 指定字符最大长度
		maxLength : {
			validator : function(value, param) {
				return rules.length.validator(value, [ 0, param[0] ]);
			},
			message : "最多输入 {0} 个字符."
		},
		// 指定字符的长度范围
		...
		contains : {
			validator : function(value, param) {
				return $.string.contains(value, param[0]);
			},
			message : "输入的内容必须包含 {0}."
		},
		// 以指定的字符开头
		startsWith : {
			validator : function(value, param) {
				return $.string.startsWith(value, param[0]);
			},
		...
		endsWith : {
			validator : function(value, param) {
				return $.string.endsWith(value, param[0]);
			},
			message : "输入的内容必须以 {0} 作为起始字符."
		},
		...
		longDate : {
			validator : function(value) {
				return $.string.isLongDate(value);
			},
		...
		shortDate : {
			validator : function(value) {
				return $.string.isShortDate(value);
			},
		...
		telOrMobile : {
			validator : function(value) {
				return $.string.isTelOrMobile(value);
			},
		...
		existChinese : {
			validator : function(value) {
				return $.string.existChinese(value);
			},
		...
		fileName : {
			validator : function(value) {
				return $.string.isFileName(value);
			},
		...
		ipv4url : {
			validator : function(value) {
				return $.string.isUrlOrIPv4(value);
			},
		...
		currency : {
			validator : function(value) {
				return $.string.isCurrency(value);
			},
		...
		msn : {
			validator : function(value) {
				return $.string.isMSN(value);
			},
			message : "输入的内容必须是正确 MSN 账户名格式."
		},
		unNormal : {
			validator : function(value) {
				return $.string.isUnNormal(value);
			},
		...
		carEngineNo : {
			validator : function(value) {
				return $.string.isCarEngineNo(value);
			},
		...
		integerRange : {
			validator : function(value, param) {
				return $.string.isInteger(value)
						&& ((param[0] || value >= param[0]) && (param[1] || value <= param[1]));
			},
		...
		numeric : {
			validator : function(value, param) {
				return $.string.isNumeric(value, param ? param[0] : undefined);
			},
		...
		numericRange : {
			validator : function(value, param) {
				return $.string.isNumeric(value, param ? param[2] : undefined)
						&& ((param[0] || value >= param[0]) && (param[1] || value <= param[1]));
			},
	...
	$.fn.validatebox = function(options, param) {
		...
		options = options || {};
		return this.each(function() {
			var jq = $.util.parseJquery(this), opts = $.extend({},
	...
	var methods = $.fn.validatebox.extensions.methods = {
		// 扩展 easyui-validatebox 的自定义扩展方法；设置当前 easyui-validatebox 控件的 prompt
		// 值；该方法的参数 prompt 表示将被设置的 prompt 值；
	...
	var defaults = $.fn.validatebox.extensions.defaults = {
		// 增加 easyui-validatebox 的扩展属性 prompt，该属性功能类似于 easyui-searchbox 的 prompt
		// 属性。
		// 表示该验证输入框的提示文本；String 类型值，默认为 null。
		prompt : null,

		// 增加 easyui-validatebox 的扩展属性 autoFocus，该属性表示在当前页面加载完成后，该
		// easyui-validatebox 控件是否自动获得焦点。
		// Boolean 类型值，默认为 false。
		autoFocus : false
	};
	...
	var css = ".validatebox-prompt{ color: #ccc; }";
	$.util.addCss(css);
	...
	$.fn.val = function(value) {
		var val, opts;
		if (this.length > 0 && this.is(".validatebox-text.validatebox-prompt")
				&& !$.html5.testProp("placeholder", this[0].nodeName)) {
...
(function($, undefined) {
	...
	function setPrompt(target, prompt) {
		var t = $.util.parseJquery(target), opts = t.combo("options"), textbox = t
				.combo("textbox");
		opts.prompt = prompt;
	...
	function setIcon(target, iconCls) {
		...
		var arrow = combo.find("span.combo-arrow").removeAttr("class")
				.addClass("combo-arrow");
		if (iconCls) {
			arrow.addClass(iconCls);
		}
	...
	function destroy(target) {
		...
		if ($.isFunction(opts.onBeforeDestroy)
				&& opts.onBeforeDestroy.call(target) == false) {
			return;
		}
	...
	function initialize(target) {
		var t = $.util.parseJquery(target), state = $.data(target, "combo"), opts = t
				.combo("options"), panel = state.panel, combo = state.combo, arrow = combo
				.find(".combo-arrow"), exts = opts.extensions ? opts.extensions
				: opts.extensions = {};
		if (!exts._initialized) {
			t.combo("textbox").focus(function() {
				if (opts.autoShowPanel && panel.is(":hidden")) {
					t.combo("showPanel");
				}
			});
	...
	var defaults = $.fn.combo.extensions.defaults = {
		...
		// 增加 easyui-combo 的自定义扩展属性；表示该 combox 组件是否在 textbox 文本显示框获取焦点时自动执行
		// showPanel 方法显示下拉 panel 面板；
	...
	var methods = $.fn.combo.extensions.methods = {
		...
		// 扩展 easyui-combo 组件的自定义方法；用于设置该 combo 的 textbox 输入框的 prompt(输入提示文字)
		// 值；该方法定义如下参数：
		// prompt: String 类型值，表示要被设置的 prompt 值；
		// 返回值：返回表示当前 easyui-combo 控件的 jQuery 链式对象。
		// setPrompt: function (jq, prompt) { return jq.each(function () {
		// setPrompt(this, prompt); }); },
...
(function($, undefined) {
	...
	var initialize = function(target) {
									...
									if (opts.enableHeaderContextMenu) {
										...
										var items = [
												...
												"-",
												{
													...
													disabled : !opts.closable,
													onclick : function() {
														t.window("close");
													}
												} ];
										var headerContextMenu = $.array
												.likeArray(opts.headerContextMenu) ? opts.headerContextMenu
												: [];
										if (headerContextMenu.length) {
											$.array.insertRange(items, 0,
													$.util.merge([],
															headerContextMenu,
															"-"));
										}
		...
		if (opts.draggable) {
			...
			dragOpts.onStartDrag = function() {
				...
				t.window("body").addClass("window-body-hidden").children()
						.addClass("window-body-hidden-proxy");
			};
			dragOpts.onStopDrag = function() {
				_onStopDrag.apply(this, arguments);
				t.window("body").removeClass("window-body-hidden").children()
						.removeClass("window-body-hidden-proxy");
			};
		}
	};
		...
		return $.array
				.map(
						...
						function(value, index) {
							...
							ret.onclick = $.isFunction(value.onclick) ? function(
									e, item, menu) {
								value.onclick.call(this, e, win, item, menu);
							}
									: value.onclick;
							ret.handler = $.isFunction(value.handler) ? function(
									e, item, menu) {
								value.handler.call(this, e, win, item, menu);
							}
									: value.handler;
							if (ret.children && ret.children.length) {
								ret.children = parseContextMenuMap(e,
										ret.children, win);
							}
							return ret;
						});
	...
	var defaults = $.fn.window.extensions.defaults = $.extend({}, {
		...
		// 扩展 easyui-window 以及 easyui-dialog
		// 控件的自定义属性，表示该窗口对象是否在屏幕大小调整的情况下自动进行左右居中，默认为 true。
		autoHCenter : true,

		// 扩展 easyui-window 以及 easyui-dialog
		// 控件的自定义属性，表示该窗口对象是否在屏幕大小调整的情况下自动进行上下居中，默认为 true。
		autoVCenter : true,
		...
		// bold: Boolean 类型值，默认为 false；表示该菜单项是否字体加粗；
		// style: JSON-Object 类型值，默认为 null；表示要附加到该菜单项的样式；
		// handler: 表示菜单项的点击事件，该事件函数格式为 function(e, win, item, menu)，其中 this
		// 指向菜单项本身
	...
	$(function() {
		// 设置当屏幕大小调整时，所有 easyui-window 或 easyui-dialog 窗口在属性 autoHCenter: true 或
		// autoVCenter: true 的情况下自动居中。
		$(window)
				.resize(
						function() {
									...
									.each(
											function() {
												...
												if (opts && opts.draggable) {
													if (opts.autoHCenter
															|| opts.autoVCenter) {
														var method = opts.autoHCenter
																&& opts.autoVCenter ? "center"
																: (opts.autoHCenter ? "hcenter"
																		: "vcenter");
														win.window(method);
													} else if (opts.inContainer) {
														win.window("move");
													}
												}
											});
		...
		// 在当前打开 modal:true 的 easyui-window 或者 easyui-dialog 时，按 ESC 键关闭顶层的
		// easyui-window 或者 easyui-dialog 对象。
		$(document).keydown(
				function(e) {
					if (e.which == 27) {
						$("div.window-mask:last").prevAll(
								"div.panel.window:first").children(
								".panel-body.window-body").each(
								function() {
									var win = $(this), opts = win
											.window("options");
									if (opts
	...
	var css = ".window-body-hidden { background-color: #95b8e7; filter: alpha(opacity=60); opacity: 0.6; }"
...
(function($, undefined) {
	...
	var updateRow = function(target, param) {
		if (!param || !param.row || !$.isNumeric(param.index)) {
			return;
		}
		var t = $.util.parseJquery(target), opts = t.datagrid("options");
		if ($.isFunction(opts.onBeforeUpdateRow)
				&& opts.onBeforeUpdateRow.call(target, param.index, param.row) == false) {
			return;
		}
		...
		if ($.isFunction(opts.onUpdateRow)) {
			opts.onUpdateRow.call(target, param.index, param.row);
		}
	};
	var appendRow = function(target, row) {
		...
		var t = $.util.parseJquery(target), opts = t.datagrid("options");
		if ($.isFunction(opts.onBeforeAppendRow)
				&& opts.onBeforeAppendRow.call(target, row) == false) {
			return;
		}
		...
		if ($.isFunction(opts.onAppendRow)) {
			opts.onAppendRow.call(target, row);
		}
	};
	var insertRow = function(target, param) {
		...
		var t = $.util.parseJquery(target), opts = t.datagrid("options");
		if ($.isFunction(opts.onBeforeInsertRow)
				&& opts.onBeforeInsertRow.call(target, param.index, param.row) == false) {
			return;
		}
		...
		initRowDndExtensions(t, opts);
		initColumnRowTooltip(t, opts, param.index, param.row);
		if ($.isFunction(opts.onInsertRow)) {
			opts.onInsertRow.call(target, param.index, param.row);
		}
	};

	var isChecked = function(target, index) {
		var t = $.util.parseJquery(target), rows = t.datagrid("getChecked"), list = $.array
				.map(rows, function(val) {
					return t.datagrid("getRowIndex", val);
				});
		return $.array.contains(list, index);
	};

	var isSelected = function(target, index) {
		var t = $.util.parseJquery(target), rows = t.datagrid("getSelections"), list = $.array
				.map(rows, function(val) {
					return t.datagrid("getRowIndex", val);
				});
		return $.array.contains(list, index);
	...
	var freezeColumn = function(target, field) {
		var t = $.util.parseJquery(target), fields = t
				.datagrid("getColumnFields"), frozenFields = t.datagrid(
				"getColumnFields", true);
		if (!frozenFields || !frozenFields.length
				|| !$.array.contains(fields, field)
				|| $.array.contains(frozenFields, field)) {
			return;
		}
	...
	var unfreezeColumn = function(target, field) {
		var t = $.util.parseJquery(target), fields = t
				.datagrid("getColumnFields"), frozenFields = t.datagrid(
				"getColumnFields", true);
		if (!fields || !fields.length || $.array.contains(fields, field)
				|| !$.array.contains(frozenFields, field)) {
			return;
		}
		t.datagrid("moveColumn", {
	...
	var moveRow = function(target, param) {
		if (!param || !$.isNumeric(param.source) || !$.isNumeric(param.target)
				|| param.source == param.target || !param.point) {
			return;
		}
		if (!$.array.contains([ "top", "bottom" ], param.point)) {
			param.point = "top";
		}
		var t = $.util.parseJquery(target), opts = t.datagrid("options"), rows = t
				.datagrid("getRows"), sourceRow = rows[param.source], targetRow = rows[param.target];
		if (!sourceRow || !targetRow) {
			return;
		}
		if ($.isFunction(opts.onBeforeDrop)
				&& opts.onBeforeDrop.call(target, targetRow, sourceRow,
						param.point) == false) {
			return;
		}
		var row = t.datagrid("popRow", param.source), index = t.datagrid(
				"getRowIndex", targetRow);
		rows = t.datagrid("getRows");
		switch (param.point) {
		case "top":
			t.datagrid("insertRow", {
				index : index,
				row : row
			});
			break;
		...
		if (row && $.isFunction(opts.onDrop)) {
			opts.onDrop.call(target, targetRow, sourceRow, param.point);
		}
	};

	var shiftRow = function(target, param) {
		if (!param || !$.isNumeric(param.index) || !param.point
				|| !$.array.contains([ "up", "down" ], param.point)) {
			return;
		}
		var t = $.util.parseJquery(target), opts = t.datagrid("options"), index = param.point == "up" ? param.index - 1
				: param.index + 1, point = param.point == "up" ? "top"
				: "bottom";
		t.datagrid("moveRow", {
			source : param.index,
			target : index,
	...
	var enableRowDnd = function(target) {
		...
		t
				.datagrid("getPanel")
				.find(
						"div.datagrid-view div.datagrid-body table.datagrid-btable tr.datagrid-row")
				.draggable(
						{
							disabled : false,
							revert : true,
							...
							proxy : function(source) {
								var tr = $.util.parseJquery(source), index = parseInt(tr
										.attr("datagrid-row-index")), dom = t
										.datagrid("getRowDom", index).clone(), temp = $(
										"<tr></tr>").addClass(
										"datagrid-row datagrid-row-selected");
								$(
										"<td><span class='tree-dnd-icon tree-dnd-no' ></span></td>")
										.appendTo(temp);
								var td = dom.find("td").each(function(i) {
									if (i < 6) {
										temp.append(this);
									}
								});
								if (td.length > 6) {
									$("<td>...</td>").css("width", "40px")
											.appendTo(temp);
								}
								return $("<table></table>").addClass(
										"tree-node-proxy").appendTo("body")
										.append(temp).hide();
							},
							onBeforeDrag : function(e) {
								var tr = $.util.parseJquery(this), index = parseInt(tr
										.attr("datagrid-row-index")), row = t
										.datagrid("getRowData", index);
								if ($.isFunction(opts.onBeforeDrag)
										&& opts.onBeforeDrag.call(target,
												index, row) == false) {
									return false;
								}
								if (e.which != 1) {
							...
							onStartDrag : function() {
								var tr = $.util.parseJquery(this), index = parseInt(tr
										.attr("datagrid-row-index")), row = t
										.datagrid("getRowData", index);
								tr.draggable("proxy").css({
									left : -10000,
									top : -10000
								});
								if ($.isFunction(opts.onBeforeDrag)) {
									opts.onStartDrag.call(target, index, row);
								}
							},
							onStopDrag : function() {
								var tr = $.util.parseJquery(this), index = parseInt(tr
								...
								if ($.isFunction(opts.onStopDrag)) {
									opts.onStopDrag.call(target, index, row);
								}
							},
							onDrag : function(e) {
								var x1 = e.pageX, y1 = e.pageY, x2 = e.data.startX, y2 = e.data.startY;
				...
				.droppable(
						{
							...
							onDragEnter : function(e, source) {
								var droper = $.util.parseJquery(this), drager = $.util
										.parseJquery(source), droperIndex = parseInt(droper
										.attr("datagrid-row-index")), dragerIndex = parseInt(drager
										.attr("datagrid-row-index")), droperRow = t
										.datagrid("getRowData", droperIndex), dragerRow = t
										.datagrid("getRowData", dragerIndex), droperRowDom = t
										.datagrid("getRowDom", droperIndex), mark = droperRowDom
										.find("td");
								var dnd = droper.data("dnd"), data = {
									droper : droper,
									drager : drager,
									droperIndex : droperIndex,
									dragerIndex : dragerIndex,
									droperRow : droperRow,
									dragerRow : dragerRow,
									droperRowDom : droperRowDom,
									mark : mark
								};
								if (!dnd) {
									droper.data("dnd", data);
								} else {
									$.extend(dnd, data);
								}
								if ($.isFunction(opts.onDragEnter)
										&& opts.onDragEnter.call(target,
												droperRow, dragerRow) == false) {
									setDroppableStatus(drager, false);
									mark
											.removeClass("datagrid-header-cell-top datagrid-header-cell-bottom");
									droper.droppable("disable");
								}
							},
							onDragOver : function(e, source) {
								var droper = $.util.parseJquery(this), dnd = droper
										.data("dnd"), drager = dnd.drager, droperRow = dnd.droperRow, dragerRow = dnd.dragerRow, mark = dnd.mark;
								if (droper.droppable("options").disabled) {
									return;
								}
								var pageY = source.pageY, top = droper.offset().top, height = top
										+ droper.outerHeight();
								...
								if (pageY > top + (height - top) / 2) {
									mark
											.addClass("datagrid-header-cell-bottom");
								} else {
									mark.addClass("datagrid-header-cell-top");
								}
								if (opts.onDragOver.call(target, droperRow,
										dragerRow) == false) {
									setDroppableStatus(drager, false);
									mark
											.removeClass("datagrid-header-cell-top datagrid-header-cell-bottom");
							...
							onDragLeave : function(e, source) {
								...
								if ($.isFunction(opts.onDragLeave)) {
									opts.onDragLeave.call(target, droperRow,
											dragerRow);
								}
							},
							...
							onDrop : function(e, source) {
								var droper = $.util.parseJquery(this), dnd = droper
										.data("dnd"), droperIndex = dnd.droperIndex, dragerIndex = dnd.dragerIndex, mark = dnd.mark, point = mark
										.hasClass("datagrid-header-cell-top") ? "top"
										: "bottom";
								t.datagrid("moveRow", {
									target : droperIndex,
									source : dragerIndex,
		...
		function setDroppableStatus(source, state) {
			...
			icon.removeClass("tree-dnd-yes tree-dnd-no").addClass(
					state ? "tree-dnd-yes" : "tree-dnd-no");
		}
		;
	};
	...
	var getNextColumn = function(target, field) {
		var t = $.util.parseJquery(target), fields = $.array.merge([], t
				.datagrid("getColumnFields", true), t.datagrid(
				"getColumnFields", false)), index = $.array.indexOf(fields,
				field);
	...
	var moveColumn = function(target, param) {
		if (!param || !param.source || !param.target
				|| param.source == param.target || !param.point) {
			return;
		}
		;
		if (!$.array.contains([ "before", "after" ], param.point)) {
			param.point = "before";
		}
		var t = $.util.parseJquery(target);
		if (t.datagrid("hasMuliRowHeader")) {
			return;
		}
		var opts = t.datagrid("options"), sourceFrozen, targetFrozen, fields = t
				.datagrid("getColumnFields"), frozenFields = t.datagrid(
				"getColumnFields", true);
		if ($.array.contains(fields, param.source)) {
			sourceFrozen = false;
		}
		if (sourceFrozen == undefined
				&& $.array.contains(frozenFields, param.source)) {
			sourceFrozen = true;
		}
		if ($.array.contains(fields, param.target)) {
			targetFrozen = false;
		}
		if (targetFrozen == undefined
				&& $.array.contains(frozenFields, param.target)) {
			targetFrozen = true;
		}
		if (sourceFrozen == undefined || targetFrozen == undefined) {
			return;
		}
		if ($.isFunction(opts.onBeforeMoveColumn)
				&& opts.onBeforeMoveColumn.call(target, param.source,
						param.target, param.point) == false) {
			return;
		}
		var panel = t.datagrid("getPanel"), view = panel
				.find("div.datagrid-view"), view1 = view
				.find("div.datagrid-view1"), view2 = view
				.find("div.datagrid-view2"), headerRow1 = view1
				.find("table.datagrid-htable tr.datagrid-header-row"), headerRow2 = view2
				.find("table.datagrid-htable tr.datagrid-header-row"), borderRow1 = view1
				.find("table.datagrid-btable tr.datagrid-row"), borderRow2 = view2
				.find("table.datagrid-btable tr.datagrid-row"), sourceHeaderTd = sourceFrozen ? headerRow1
				.find("td[field=" + param.source + "]")
				: headerRow2.find("td[field=" + param.source + "]"), targetHeaderTd = targetFrozen ? headerRow1
				.find("td[field=" + param.target + "]")
				: headerRow2.find("td[field=" + param.target + "]"), sourceRow = sourceFrozen ? borderRow1
				: borderRow2, targetRow = targetFrozen ? borderRow1
				: borderRow2;
		...
		targetRow
				.each(function(i, n) {
					var targetBodyTd = $(this).find(
							"td[field=" + param.target + "]"), sourceBodyTd = $(
							sourceRow[i])
							.find("td[field=" + param.source + "]");
					targetBodyTd[param.point](sourceBodyTd);
				});
		var sourceOpts = t.datagrid("getColumnOption", param.source), targetOpts = t
				.datagrid("getColumnOption", param.target), sourceColumns = sourceFrozen ? opts.frozenColumns[0]
				: opts.columns[0], targetColumns = targetFrozen ? opts.frozenColumns[0]
				: opts.columns[0], exts = opts._extensionsDatagrid ? opts._extensionsDatagrid
				: (opts._extensionsDatagrid = {});
		$.array.remove(sourceColumns, sourceOpts);
		var index = $.array.indexOf(targetColumns, targetOpts);
		if (index > -1) {
			$.array.insert(targetColumns, param.point == "before" ? index
					: index + 1, sourceOpts);
		}
		...
		if (sourceFrozen) {
			if (!targetFrozen) {
				...
				$.array.insert(exts.fields, param.point == "before" ? index
						: index + 1, param.source);
				$.array
						.insert(exts.fieldOptions,
								param.point == "before" ? index : index + 1,
								sourceOpts);
				$.array.insert(exts.fieldOptionsBackup,
						param.point == "before" ? index : index + 1, $.extend(
								{}, sourceOpts));
			}
		}
		if (!sourceFrozen) {
			...
			if (targetFrozen) {
				...
				$.array.insert(exts.fields, param.point == "before" ? index
						: index + 1, param.source);
				$.array.insert(exts.fieldOptions,
						param.point == "before" ? index : index + 1, fieldOpts);
				$.array.insert(exts.fieldOptionsBackup,
						param.point == "before" ? index : index + 1,
						fieldOptsBak);
			}
		...
		if ($.isFunction(opts.onMoveColumn)) {
			opts.onMoveColumn.call(target, param.source, param.target,
					param.point);
		}
	}

	var shiftColumn = function(target, param) {
		if (!param || !param.field || !param.point) {
			return;
		}
		;
		if (!$.array.contains([ "before", "after" ], param.point)) {
		...
		var t = $.util.parseJquery(target), fields = t.datagrid(
				"getColumnFields", "all"), index = $.array.indexOf(fields,
				param.field);
		if (index == -1 || (param.point == "before" && index == 0)
				|| (param.point == "after" && index == fields.length - 1)) {
			return;
		}
	...
	var deleteColumn = function(target, field) {
		var t = $.util.parseJquery(target), opts = t.datagrid("options"), exts = opts._extensionsDatagrid ? opts._extensionsDatagrid
				: (opts._extensionsDatagrid = {});
		if ($.isFunction(opts.onBeforeDeleteColumn)
				&& opts.onBeforeDeleteColumn.call(target, field) == false) {
			return;
		}
		removeField(opts, field, exts);
		t.datagrid("getColumnDom", {
			field : field,
			header : true
		}).remove();
	...
	var popColumn = function(target, field) {
		var t = $.util.parseJquery(target), colOpts = t.datagrid(
	...
	var removeField = $.fn.datagrid.extensions.removeField = function(opts,
			field, exts) {
	...
	var findRows = function(target, param) {
		...
		if ($.isFunction(param)) {
			...
			ret = $.array.map(param, function(val) {
				return findRow(target, val, t, rows);
			});
			ret = $.array.filter(ret, function(val) {
	...
	var findRow = function(target, param, grid, rows) {
		var t = grid || $.util.parseJquery(target), data = rows
				|| t.datagrid("getRows"), opts = t.datagrid("options");
		return $.array.first(rows, $.isFunction(param) ? param : function(val) {
			return val[opts.idField] == param;
		});
	};
	...
	var deleteRow = function(target, param) {
		...
		if (isFunc) {
			...
			if (row) {
				_deleteRow.call(t, t, row);
			}
		} else {
			index = $.isNumeric(param) ? param : t.datagrid("getRowIndex",
					param);
	...
	var setColumnTitle = function(target, param) {
		if (param && param.field && param.title) {
			var t = $.util.parseJquery(target), colOpts = t.datagrid(
					"getColumnOption", param.field), field = param.field, title = param.title, panel = t
					.datagrid("getPanel"), td = panel
					.find("div.datagrid-view div.datagrid-header tr.datagrid-header-row td[field="
							+ field + "]");
			if (td.length) {
				td.find("div.datagrid-cell span:first").html(title);
				colOpts.title = title;
			}
		}
	};
	...
	var setColumnWidth = function(target, param) {
		if (param && param.field && param.width && $.isNumeric(param.width)) {
			var state = $.data(target, "datagrid"), t = $.util
					.parseJquery(target), opts = t.datagrid("options"), colOpts = t
					.datagrid("getColumnOption", param.field), field = param.field, width = param.width, cell = t
					.datagrid("getPanel").find(
							"div.datagrid-view div.datagrid-header tr.datagrid-header-row td[field="
									+ field + "] div.datagrid-cell");
			if (cell.length) {
	...
	var sortGrid = function(target, options) {
		...
		var t = $.util.parseJquery(target), state = $.data(target, "datagrid"), opts = t
				.datagrid("options"), col = t.datagrid("getColumnOption",
				options.sortName);
		if (!col || $.isEmptyObject(col) || !col.sortable || state.resizing) {
			return;
		}
		opts.sortName = options.sortName;
		opts.sortOrder = options.sortOrder;
		var cls = "datagrid-sort-" + opts.sortOrder;
		var cells = t.datagrid("getPanel").find(
				".datagrid-view .datagrid-header td div.datagrid-cell");
		var cell = t.datagrid("getPanel").find(
				".datagrid-view .datagrid-header td[field='" + options.sortName
						+ "'] div.datagrid-cell");
		if (!cells.length || !cell.length) {
			return;
		}
	...
	var setOffset = function(target, offset) {
		var t = $.util.parseJquery(target), opts = t.datagrid("options"), exts = opts._extensionsDatagrid ? opts._extensionsDatagrid
				: (opts._extensionsDatagrid = {});
		opts.offset = exts.offset = $.fn.datagrid.extensions
				.parseOffset(offset);
		if (exts.offset && exts.offset.enable) {
			if (!$.isFunction(exts.offsetFunction)) {
				exts.offsetFunction = function() {
					if (!exts.offset.enable) {
						return;
					}
					var size = $.util.windowSize();
					t.datagrid("resize", {
						width : size.width + exts.offset.width,
						height : size.height + exts.offset.height
					});
				};
	...
	var getColumnDom = function(target, param) {
		...
		var t = $.util.parseJquery(target), panel = t.datagrid("getPanel"), isObject = !$.string
				.isString(param), field = isObject ? param.field : param, header = isObject ? param.header
				: false, dom = panel
				.find("div.datagrid-view tr.datagrid-row td[field=" + field
						+ "]");
		if (header) {
			dom = dom.add(panel
					.find("div.datagrid-view tr.datagrid-header-row td[field="
							+ field + "]"));
		}
		return dom;
	};
	...
	var getColumnData = function(target, field) {
		var t = $.util.parseJquery(target), rows = t.datagrid("getRows");
		return $.array.map(rows, function(val) {
			return val[field];
		});
	};
	...
	var getRowDom = function(target, index) {
		...
		return panel
				.find("div.datagrid-view div.datagrid-body table.datagrid-btable tr.datagrid-row[datagrid-row-index="
						+ index + "]");
	};
	...
	var getCellDom = function(target, pos) {
		if (!pos || !pos.field || !$.isNumeric(pos.index) || pos.index < 0) {
			return $();
		}
		var t = $.util.parseJquery(target), tr = t.datagrid("getRowDom",
				pos.index);
	...
	var getCellData = function(target, pos) {
		...
		var t = $.util.parseJquery(target), row = t.datagrid("getRowData",
				pos.index);
	...
	var getColumnFields = function(target, frozen) {
		var t = $.util.parseJquery(target);
		if (frozen == null || frozen == undefined || $.util.isBoolean(frozen)) {
			return _getColumnFields.call(t, t, frozen);
		}
		if ($.util.isString(frozen)) {
			return $.array.merge([], _getColumnFields.call(t, t, true),
					_getColumnFields.call(t, t, false));
		}
	};
	...
	var getDistinctRows = function(target, field) {
		...
		$.array.distinct(data, function(a, b) {
	...
	var getColumns = function(target, frozen) {
		var t = $.util.parseJquery(target), fields = getColumnFields(target,
				frozen);
	...
	var getHiddenColumns = function(target, frozen) {
		...
		return $.array.filter(cols, function(val) {
			return val.hidden ? true : false;
		});
	};
	...
	var showRow = function(target, param, grid, options, data, extensions,
			refreshable) {
		var t = grid || $.util.parseJquery(target), rows = data
				|| t.datagrid("getRows"), row = $.isFunction(param) ? findRow(
				target, param, t, rows) : param, index = t.datagrid(
				"getRowIndex", row), refreshable = (refreshable == null
				|| refreshable == undefined || refreshable == true) ? true
				: false;
		if (index > -1) {
			var opts = options || t.datagrid("options"), rowData = t.datagrid(
					"getRowData", index), exts = extensions
					|| (opts._extensionsDatagrid ? opts._extensionsDatagrid
							: (opts._extensionsDatagrid = {}));
	...
	var hideRow = function(target, param, grid, options, data, extensions,
			refreshable) {
		var t = grid || $.util.parseJquery(target), rows = data
				|| t.datagrid("getRows"), row = $.isFunction(param) ? findRow(
				target, param, t, rows) : param, index = t.datagrid(
	...
	var showRows = function(target, param) {
		var t = $.util.parseJquery(target), opts = t.datagrid("options"), rows = t
				.datagrid("getRows"), array, exts = opts._extensionsDatagrid ? opts._extensionsDatagrid
				: (opts._extensionsDatagrid = {});
		if (param === true) {
			exts.filterData = [];
			var panel = t.datagrid("getPanel"), icons = panel
					.find("div.datagrid-header-filter-item-icon");
		...
		if (array) {
			$.each(array, function(index, val) {
				showRow(target, val, t, opts, rows, exts, false);
			});
			refreshColumnFilterStatus(t, opts, exts, rows);
		}
	};
	...
	var hideRows = function(target, param) {
		...
		if (array) {
			$.each(array, function(index, val) {
				hideRow(target, val, t, opts, rows, exts, false);
			});
			refreshColumnFilterStatus(t, opts, exts, rows);
		}
	};
	...
	var getVisibleRows = function(target) {
		var t = $.util.parseJquery(target), opts = t.datagrid("options"), rows = t
				.datagrid("getRows"), exts = opts._extensionsDatagrid ? opts._extensionsDatagrid
				: (opts._extensionsDatagrid = {}), filterData = $
				.isArray(exts.filterData) ? exts.filterData : [];
		return $.array.filter(rows, function(val) {
			return $.array.contains(filterData, val) ? false : true;
		});
	};

	var setColumnFilter = function(target, columnFilter) {
		var t = $.util.parseJquery(target), opts = t.datagrid("options"), exts = opts._extensionsDatagrid ? opts._extensionsDatagrid
				: (opts._extensionsDatagrid = {}), panel = t
				.datagrid("getPanel"), selector = "div.datagrid-view div.datagrid-header tr.datagrid-header-row div.datagrid-header-filter-container";
		if (!columnFilter) {
	...
	var columnFilterSelect = function(target, param) {
		var t = $.util.parseJquery(target);
		if ($.util.isBoolean(param)) {
			t.datagrid(param ? "showRows" : "hideRows", true);
			return;
		}
		if (!param || !param.field) {
			return;
		}
		var field = param.field, value = param.value, isArray = $.array
				.likeArray(value)
				&& !$.util.isString(value), finder = isArray ? function(val) {
			return $.array.contains(value, val[field]);
		} : function(val) {
	...
	var livesearch = function(target, param) {
		...
		if ($.isPlainObject(param)) {
			...
			cells = panel.find("div.datagrid-body tr.datagrid-row td["
					+ (field ? "field=" + field : "field")
					+ "] div.datagrid-cell");
		} else {
			cells = panel
					.find("div.datagrid-body tr.datagrid-row td[field] div.datagrid-cell");
		}
		...
		cells.each(function() {
			...
			cell.html($.string.replaceAll(text, value,
					"<span class='datagrid-cell-hightlight'>" + value
							+ "</span>"));
		});
	};
	...
	var initColumnExtendProperty = $.fn.datagrid.extensions.initColumnExtendProperty = function(
			colOpts) {
		if (colOpts.tooltip == null || colOpts.tooltip == undefined) {
			colOpts.tooltip = false;
		}
		if (colOpts.filterable == null || colOpts.filterable == undefined
				|| !$.util.isBoolean(colOpts.filterable)) {
			colOpts.filterable = true;
		}
		if (colOpts.hidable == null || colOpts.hidable == undefined
				|| !$.util.isBoolean(colOpts.hidable)) {
			colOpts.hidable = true;
		}
		if (colOpts.filter == null || colOpts.filter == undefined
				|| !$.util.isString(colOpts.filter)) {
			colOpts.filter = "checkbox";
		}
		if (colOpts.precision == null || colOpts.precision == undefined
				|| !$.isNumeric(colOpts.precision)) {
			colOpts.precision = 1;
		}
		if (colOpts.step == null || colOpts.step == undefined
				|| !$.isNumeric(colOpts.step)) {
			colOpts.step = 1;
		}
	};

	var initColumnExtendProperties = $.fn.datagrid.extensions.initColumnExtendProperties = function(
			t, exts) {
		if (exts._initializedExtendProperties) {
			return;
		}
		var cols = t.datagrid("getColumns", "all");
		$.each(cols, function() {
			initColumnExtendProperty(this);
		});
		exts._initializedExtendProperties = true;
	};

	var initRowDndExtensions = $.fn.datagrid.extensions.initRowDndExtensions = function(
			t, opts) {
		opts = opts || t.datagrid("options");
		if (opts.dndRow) {
			t.datagrid("enableRowDnd");
		}
	};
	...
	function initHeaderColumnFilterContainer(t, opts, exts) {
		...
		exts.oldData = data;
		var header = t.datagrid("getPanel").find(
				"div.datagrid-view div.datagrid-header"), headerRows = header
				.find("table.datagrid-htable tr.datagrid-header-row"), headerFields = headerRows
				.find("td[field]")
				.filter(
						function() {
							...
							return (!colspan || colspan == "1")
									&& !td
											.find("div.datagrid-header-check,div.datagrid-header-rownumber").length ? true
									: false;
						}), columnFilter = opts.columnFilter = $.extend({
			panelHeight : 100,
			position : "top"
		}, opts.columnFilter), position = $.array.contains([ "top", "bottom" ],
				columnFilter.position) ? columnFilter.position : "top", panelHeight = columnFilter.panelHeight = $
				.isNumeric(columnFilter.panelHeight)
				&& columnFilter.panelHeight >= 60 ? columnFilter.panelHeight
				: 60, height = header.height(), rows = t.datagrid("getRows");
		headerFields
				.each(function() {
					var td = $(this)
							.addClass("datagrid-header-filter")
							.removeClass(
									"datagrid-header-filter-top datagrid-header-filter-bottom"), cell = td
							.find("div.datagrid-cell").addClass(
									"datagrid-header-filter-cell"), field = td
							.attr("field"), colOpts = t.datagrid(
							"getColumnOption", field), colWidth = colOpts.width, line = $(
							"<hr />").addClass("datagrid-header-filter-line")[position == "top" ? "prependTo"
							: "appendTo"](this), container = $("<div></div>")
							.attr("field", field).addClass(
									"datagrid-header-filter-container").css({
								height : columnFilter.panelHeight,
								width : colWidth
							})[position == "top" ? "prependTo" : "appendTo"]
							(this);
					td
							.addClass(position == "top" ? "datagrid-header-filter-top"
									: "datagrid-header-filter-bottom");
					if (field) {
						initColumnFilterField(t, opts, exts, container,
								colOpts, rows, headerFields);
					}
				});
	...
	function clearHeaderColumnFilter(t, opts) {
		...
		var headerFields = t
				.datagrid("getPanel")
				.find(
						"div.datagrid-view div.datagrid-header table.datagrid-htable tr.datagrid-header-row td[field]")
				.filter(
						function() {
							var td = $(this), colspan = td.attr("colspan");
							return (!colspan || colspan == "1")
		...
		headerFields
				.removeClass(
						"datagrid-header-filter datagrid-header-filter-top datagrid-header-filter-bottom")
				.find("div.datagrid-cell").removeClass(
						"datagrid-header-filter-cell");
		headerFields
				.find(
						"hr.datagrid-header-filter-line,div.datagrid-header-filter-container")
				.remove();
	...
	function initColumnFilterField(t, opts, exts, container, colOpts, rows,
			headerFields) {
		if (!colOpts.filterable) {
			return;
		}
		var field = colOpts.field, distinctVals = t.datagrid(
				"getDistinctColumnData", field), filter = $.array.contains([
				"checkbox", "livebox", "caps", "lower", "none" ],
				colOpts.filter) ? colOpts.filter : "checkbox", precision = colOpts.precision, step = colOpts.step;
		switch (filter) {
		case "checkbox":
			initColumnFilterFieldCheckBox(t, exts, container, field, rows,
					distinctVals);
			break;
		case "livebox":
			initColumnFilterFieldLiveBox(t, container, field, rows);
			break;
		case "caps":
			initColumnFilerFieldSlider(t, container, field, step, precision,
					rows, distinctVals, "<=", opts.columnFilter.panelHeight,
					headerFields);
			break;
		case "lower":
			initColumnFilerFieldSlider(t, container, field, step, precision,
	...
	function initColumnFilterFieldCheckBox(t, exts, container, field, rows,
			distinctVals) {
		$.each(distinctVals, function(index, text) {
			var item = $("<div></div>").addClass("datagrid-header-filter-item")
					.attr("text", text).appendTo(container), itemText = $(
					"<div></div>").addClass("datagrid-header-filter-item-text")
					.text(text).appendTo(item), icon = $("<div></div>")
					.addClass("datagrid-header-filter-item-icon")
					.appendTo(item), handler = function() {
				var filterRows = $.array.filter(rows, function(value) {
					return value[field] == text;
				}), hiddenRows = $.array.filter(exts.filterData,
						function(value) {
							return value[field] == text;
						});
				t.datagrid(hiddenRows.length ? "showRows" : "hideRows",
						filterRows);
			};
			item.click(handler);
		});
	...
	function initColumnFilterFieldLiveBox(t, container, field, rows) {
		$("<div></div>").addClass("datagrid-header-filter-livebox-text").text(
				"模糊过滤：").appendTo(container);
		var input = $("<input />").addClass("datagrid-header-filter-livebox")
				.appendTo(container);
		var btn = $("<a />").linkbutton({
			...
			var filterRows = $.array.filter(rows, function(value) {
				return String(value[field]).indexOf(val) == -1;
			});
	...
	function initColumnFilerFieldSlider(t, container, field, step, precision,
			rows, distinctVals, type, panelHeight, headerFileds) {
		var array = $.array.map(distinctVals, function(val) {
			val = parseFloat(val);
			return $.isNumeric(val) ? val : 0;
		}), min = array.length ? $.array.min(array) : 0, max = array.length ? $.array
				.max(array)
				: 0, maxPrecisionVal = array.length ? $.array.max(array,
				function(a, b) {
					return $.util.compare($.number.precision(a), $.number
							.precision(b));
				}) : 0, maxPrecision = array.length ? $.number
				.precision(maxPrecisionVal) : 0, height = panelHeight - 45, itemWrap = $(
				"<div></div>").addClass("datagrid-header-filter-itemwrap")
				.text(type).appendTo(container), sliderWrap = $("<div></div>")
				.addClass("datagrid-header-filter-sliderwrap").css({
					height : height + 10
				})[type == "<=" ? "appendTo" : "prependTo"](container), input = $(
				"<input />").addClass("datagrid-header-filter-numeric")
				.appendTo(itemWrap), slider = $("<input />").addClass(
				"datagrid-header-filter-slider").appendTo(sliderWrap), handler = function(
				newValue, oldValue) {
			changeSliderValue(t, field, rows, newValue, type, input, slider,
					headerFileds);
		};
		input.numberbox({
			value : type == "<=" ? max : min,
		...
		input.keypress(function(e) {
			if (e.which == 13) {
				var val = input.val();
				input.numberbox("setValue", $.isNumeric(val) ? val : 0);
			}
		});
		slider.slider({
			height : height,
			...
			tipFormatter : function(val) {
				return $.number.round(val || 0, maxPrecision);
			}
		});
	}
	;

	function changeSliderValue(t, field, rows, value, type, input, slider,
			headerFileds) {
		var headerFields = headerFileds
				|| t
						.datagrid("getPanel")
						.find(
								"div.datagrid-view div.datagrid-header table.datagrid-htable tr.datagrid-header-row td[field]")
		...
		var headerField = headerFields.filter(function() {
			return $(this).attr("field") == field;
		});
		input = input ? input : headerField
				.find(".datagrid-header-filter-numeric");
		slider = slider ? slider : headerField
				.find(".datagrid-header-filter-slider");
	...
	function refreshColumnFilterCellStatus(t, exts, rows, td, field) {
		var colOpts = colOpts = t.datagrid("getColumnOption", field), precision = colOpts.precision, filter = $.array
				.contains([ "checkbox", "livebox", "caps", "lower", "none" ],
						colOpts.filter) ? colOpts.filter : "checkbox";
		switch (filter) {
		case "checkbox":
			refreshColumnFilterCheckbox(t, exts, rows, td, field);
			break;
		case "livebox":
			refreshColumnFilterLiveBox(t, exts, rows, td, field);
			break;
		case "caps":
			refreshColumnFilterCaps(t, exts, rows, td, field);
			break;
		case "lower":
			refreshColumnFilterLower(t, exts, rows, td, field);
			break;
		case "none":
			break;
		}
	...
	function refreshColumnFilterCheckbox(t, exts, rows, td, field) {
		td.find("div.datagrid-header-filter-item").each(
				function() {
					var item = $(this), text = item.attr("text"), icon = item
							.find("div.datagrid-header-filter-item-icon");
					var length = $.array.sum(rows, function(val) {
						return val[field] == text ? 1 : 0;
					}), hiddenLength = $.array.sum(exts.filterData, function(
							val) {
						return val[field] == text ? 1 : 0;
					}), iconCls = hiddenLength == 0 ? "tree-checkbox1"
							: (hiddenLength >= length ? "tree-checkbox0"
									: "tree-checkbox2");
					$.easyui.tooltip.init(item, {
						content : ($.string.isNullOrEmpty(text) ? "空白" : text)
								+ ": 共" + length + "个元素"
					});
	...
	;
	function setItemIconCls(icon, iconCls) {
		icon.removeClass("tree-checkbox0 tree-checkbox1 tree-checkbox2")
				.addClass(iconCls);
	}
	;
	...
	function initHeaderContextMenu(t, opts, exts) {
		...
		opts.onHeaderContextMenu = function(e, field) {
			if ($.isFunction(exts.onHeaderContextMenuBak)) {
				exts.onHeaderContextMenuBak.apply(this, arguments);
			}
			if (!opts.enableHeaderContextMenu) {
				return;
			}
			var eventData = $.fn.datagrid.extensions.parseContextMenuEventData(
					t, opts, e), items = parseHeaderContextMenuItems(t, opts,
					exts, e, field, eventData);
			$.easyui.showMenu({
				items : items,
				left : e.pageX,
				top : e.pageY,
				hideDisabledMenu : opts.hideDisabledMenu
			});
			e.preventDefault();
		};
	}
	...
	function initRowContextMenu(t, opts, exts) {
		...
		opts.onRowContextMenu = function(e, rowIndex, rowData) {
			if ($.isFunction(exts.onRowContextMenuBak)) {
				exts.onRowContextMenuBak.apply(this, arguments);
			}
			...
			var eventData = $.fn.datagrid.extensions.parseContextMenuEventData(
					t, opts, e), items = parseRowContextMenuItems(t, opts,
					exts, e, rowIndex, rowData, eventData);
			if (opts.autoBindDblClickRow && opts.dblClickRowMenuIndex >= 0
					&& $.util.likeArray(opts.rowContextMenu)
					&& !$.util.isString(opts.rowContextMenu)
	...
	function initHeaderClickMenu(t, opts, exts) {
		...
		t
				.datagrid("getPanel")
				.find(
						".datagrid-view .datagrid-header table.datagrid-htable tr.datagrid-header-row td[field]")
				.filter(
						function() {
							var td = $(this), colspan = td.attr("colspan");
							return (!colspan || colspan == "1")
					...
					initHeaderCellClickMenu(t, opts, exts, this);
				});
	}
	;

	function initHeaderCellClickMenu(t, opts, exts, cell) {
		cell = $.util.parseJquery(cell);
		cell.off(".hoverArrow");
		var arrow = $(
				"<span class='s-btn-downarrow datagrid-header-cell-arrow'>&nbsp;</span>")
				.click(
						function(e) {
							var span = $(this), offset = span.offset(), height = span
									.outerHeight(), field = span.parent()
									.parent().attr("field"), eventData = $.fn.datagrid.extensions
									.parseContextMenuEventData(t, opts, e), items = parseHeaderContextMenuItems(
									t, opts, exts, e, field, eventData);
							var mm = $.easyui.showMenu({
								items : items,
								left : offset.left,
							...
							mmOpts.onHide = function() {
								arrow.hidable = true;
								arrow
										.removeClass("datagrid-header-cell-arrow-show");
	...
	function initDblClickRowEvent(t, opts, exts) {
		...
		opts.onDblClickRow = function(rowIndex, rowData) {
			if ($.isFunction(exts.onDblClickRowBak)) {
				exts.onDblClickRowBak.apply(this, arguments);
			}
			// t.datagrid("selectRow", rowIndex);
			var eventData = $.fn.datagrid.extensions.parseContextMenuEventData(
					t, opts, null);
			items = parseRowContextMenuItems(t, opts, exts, null, rowIndex,
					rowData, eventData);
			if (opts.autoBindDblClickRow && opts.dblClickRowMenuIndex >= 0
					&& $.util.likeArray(opts.rowContextMenu)
					&& !$.util.isString(opts.rowContextMenu)
					&& opts.rowContextMenu.length > opts.dblClickRowMenuIndex) {
				var item = items[opts.dblClickRowMenuIndex], handler = item.handler
						|| item.onclick;
				return handler(null, rowIndex, rowData, eventData, t, item,
						null);
			}
			if (opts.autoEditing) {
	...
	function parseHeaderContextMenuItems(t, opts, exts, e, field, eventData) {
		var items = [], contextMenu = $.util.likeArray(opts.headerContextMenu)
				&& !$.util.isString(opts.headerContextMenu) ? opts.headerContextMenu
				: [];
		if (contextMenu.length) {
			$.array.merge(items, contextMenu);
		}
		var baseItems = parseHeaderBaseContextMenuItems(t, opts, exts, e,
				field, eventData);
		if (baseItems.length) {
			$.array.merge(items, "-", baseItems);
		}
		items = $.fn.datagrid.extensions.parseHeaderContextMenuMap(e, field,
				eventData, items, t);
		if (items[0] == "-") {
			$.array.removeAt(items, 0);
		}
	...
	function parseRowContextMenuItems(t, opts, exts, e, rowIndex, rowData,
			eventData) {
		var items = [], contextMenu = $.util.likeArray(opts.rowContextMenu)
				&& !$.util.isString(opts.rowContextMenu) ? opts.rowContextMenu
				: [];
		if (contextMenu.length) {
			$.array.merge(items, contextMenu);
		}
		var baseItems = parseRowBaseContextMenuItems(t, opts, exts, e,
				rowIndex, rowData, eventData);
		if (baseItems.length) {
			$.array.merge(items, "-", baseItems);
		}
		items = $.fn.datagrid.extensions.parseRowContextMenuMap(e, rowIndex,
				rowData, eventData, items, t);
		if (items[0] == "-") {
			$.array.removeAt(items, 0);
		}
		return items;
	...
	function parseHeaderBaseContextMenuItems(t, opts, exts, e, field, eventData) {
		var mm = [], exp = opts.exportMenu, colOpts = t.datagrid(
				"getColumnOption", field), sortable = t.datagrid(
				"getColumnOption", field).sortable;
			...
			children : [
					{
						...
						iconCls : function() {
							...
							var count = $.array.sum(exts.fieldOptions,
									function(val) {
										return val.hidden ? 0 : 1;
									});
							return count >= len ? "tree-checkbox1"
									: (count == 0 ? "tree-checkbox0"
											: "tree-checkbox2");
						},
						hideOnClick : false,
						handler : function(e, field, eventData, t, item, menu) {
							$.each(exts.fields, function() {
								t.datagrid("showColumn", this);
							});
							$(this).parent().children(
									"div.menu-item:not(:eq(1))").each(
									function() {
										menu.menu("setIcon", {
											target : this,
					...
					},
					{
						...
						hideOnClick : false,
						handler : function(e, field, eventData, t, item, menu) {
							$.each(exts.fieldOptionsBackup, function() {
								t.datagrid(this.hidden == true ? "hideColumn"
										: "showColumn", this.field);
							});
							var mm = $(this).parent();
							mm
									.children("div.menu-item:gt(1)")
									.each(
											function() {
												var title = $(this).text(), colOpts = $.array
														.first(
																exts.fieldOptions,
																function(val) {
												...
												if (colOpts) {
													menu
															.menu(
																	...
																	{
																		target : this,
																		iconCls : colOpts.hidden ? "tree-checkbox0"
																				: "tree-checkbox1"
																	});
												}
												menu.menu("enableItem", this);
							...
							mm
									.children("div.menu-item:first")
									.each(
											function() {
												var len = exts.fields ? exts.fields.length
														: 0;
												var count = $.array
														.sum(
																exts.fieldOptions,
												...
												menu
														.menu(
																...
																{
																	target : this,
																	iconCls : count >= len ? "tree-checkbox1"
																			: (count == 0 ? "tree-checkbox0"
																					: "tree-checkbox2")
																});
											});
		...
		var m4 = {
			...
			disabled : !colOpts.filterable,
			children : []
		};
		var m5 = {
			text : "导出当前页",
			iconCls : "icon-standard-page-white-put",
			disabled : !(exp == true || exp.current == true),
			handler : function() {
				return t.datagrid("exportExcel", false);
			}
		};
		var m6 = {
			text : "导出全部",
			iconCls : "icon-standard-page-white-stack",
			disabled : !(exp == true || exp.all == true),
			handler : function() {
				return t.datagrid("exportExcel", true);
			}
		};
		$.util.merge(m3.children, parseHeaderColumnsShowHideMenu(t, opts, exts,
				e, field, eventData));
		if (colOpts.filterable) {
			$.util.merge(m4.children, parseHeaderRowsShowHideMenu(t, opts,
					exts, e, field, eventData));
		}
		...
		if (exp) {
			$.array.merge(mm, "-",
					typeof exp == "object" && !exp.submenu ? expMenu : {
						text : "导出数据",
	...
	function parseHeaderColumnsShowHideMenu(t, opts, exts, e, field, eventData) {
		return $.array
				.map(
						exts.fieldOptions,
						function(val) {
							var handler = function(e, field, eventData, t,
									item, menu) {
								var m = $.util.parseJquery(this), count = m
										.parent()
										.find(
												".menu-item:gt(1) .tree-checkbox1").length;
								if ((count == 1 && !val.hidden) || !val.hidable) {
									return;
								}
								t.datagrid(val.hidden ? "showColumn"
										: "hideColumn", val.field);
								menu.menu("setIcon", {
									target : this,
									iconCls : val.hidden ? "tree-checkbox0"
											: "tree-checkbox1"
								});
								count = $.array.sum(exts.fieldOptions,
										function(val) {
											return val.hidden ? 0 : 1;
										});
								var len = exts.fields ? exts.fields.length : 0;
								menu.menu("setIcon", {
									target : m.parent().children(
											"div.menu-item:first"),
									iconCls : count >= len ? "tree-checkbox1"
											: (count == 0 ? "tree-checkbox0"
													: "tree-checkbox2")
								});
								var mm = m.parent().find(".menu-item:gt(1)")
										.filter(
												function() {
													return $(".tree-checkbox1",
															this).length ? true
															: false;
												});
								mm.each(function() {
									menu.menu(mm.length > 1 ? "enableItem"
											: "disableItem", this);
								});
							};
							return {
								text : val.title || val.field,
								iconCls : val.hidden ? "tree-checkbox0"
										: "tree-checkbox1",
								hideOnClick : false,
								disabled : !val.hidable ? true : false,
								handler : handler
							};
						});
	}
	...
	function parseHeaderRowsShowHideMenu(t, opts, exts, e, field, eventData) {
		var rows = t.datagrid("getRows"), distinctVals = t.datagrid(
				"getDistinctColumnData", field), mm = [
				{
					text : "全部",
					hideOnClick : false,
					iconCls : (!exts.filterData || !exts.filterData.length) ? "tree-checkbox1"
							: (exts.filterData.length >= rows.length ? "tree-checkbox0"
									: "tree-checkbox2"),
					handler : function(e, field, eventData, t, item, menu) {
						if (exts.filterData && exts.filterData.length) {
							t.datagrid("showRows", true);
						...
						$(this)
								.parent()
								.children("div.menu-item[hideOnClick=false]")
								.each(
										function() {
											menu
													.menu(
															...
															{
																target : this,
																iconCls : exts.filterData
																		&& exts.filterData.length ? "tree-checkbox0"
																		: "tree-checkbox1"
															});
										});
					}
				}, "-" ];
		var hasMore = distinctVals.length >= 15, data = hasMore ? $.array.left(
				distinctVals, 10) : distinctVals;
		var items = $.array
				.map(
						data,
						function(val) {
							var filterRows = $.array.filter(rows, function(
									value) {
								return value[field] == val;
							}), filterLength = filterRows.length, hiddenLength = $.array
									.sum(exts.filterData, function(value) {
										return value[field] == val ? 1 : 0;
									}), iconCls = !hiddenLength ? "tree-checkbox1"
									: (hiddenLength >= filterLength ? "tree-checkbox0"
											: "tree-checkbox2");
							var handler = function(e, field, eventData, t,
									item, menu) {
								var hiddenLength = $.array.sum(exts.filterData,
										function(value) {
											return value[field] == val ? 1 : 0;
										});
								t.datagrid(hiddenLength ? "showRows"
										: "hideRows", filterRows);
								menu.menu("setIcon", {
									target : this,
									iconCls : hiddenLength ? "tree-checkbox1"
		...
		if (hasMore) {
			var colOpt = t.datagrid("getColumnOption", field), title = colOpt.title ? colOpt.title
					: colOpt.field, handler = function() {
				var checkAll = $("<input />").attr({
					type : "button",
					value : "全部选择"
				}).click(function() {
					t.datagrid("showRows", true);
				...
				$("<div></div>")
						.append(
								"<div>列：" + title + "，共" + distinctVals.length
										+ "项</div><hr />")
						.css({
							padding : "10px"
						})
								...
								function() {
									...
									$
											.each(
													distinctVals,
													function(index, text) {
														var id = "itemCheckbox_"
																+ $.util
																		.guid("N"), checked = !$.array
																.some(
																		exts.filterData,
																		function(
																				val) {
																...
																.text(text)
																.appendTo(
																		itemWrap), handler = function() {
															var filterRows = $.array
																	.filter(
																			rows,
																			function(
																					val) {
																	...
																	.sum(
																			...
																			function(
																					val) {
																				return val[field] == text ? 1
																						: 0;
																			});
															t
																	.datagrid(
																			hiddenLength ? "showRows"
																					: "hideRows",
																			filterRows);
														};
														item.click(handler);
			...
			$.array.merge(mm, [ "-", {
				text : "处理更多(共" + distinctVals.length + "项)...",
				iconCls : "icon-standard-application-view-detail",
				handler : handler
			} ]);
		}
	...
	function parseRowBaseContextMenuItems(t, opts, exts, e, rowIndex, rowData,
			eventData) {
		...
		var m2 = {
			...
			iconCls : "pagination-first",
			disabled : function() {
				return !opts.pagination || eventData.page <= 1;
			},
			handler : function() {
				if (eventData.page > 1) {
					eventData.pager.pagination("select", 1);
				}
			}
		};
		var m3 = {
			...
			handler : function() {
				if (eventData.page > 1) {
					eventData.pager.pagination("select", eventData.page - 1);
				}
			}
		};
		var m4 = {
			...
			disabled : function() {
				return !opts.pagination
						|| eventData.page >= eventData.pageCount;
			},
			handler : function() {
				if (eventData.page < eventData.pageCount) {
					eventData.pager.pagination("select", eventData.page + 1);
				}
			}
		};
		var m5 = {
			...
			handler : function() {
				if (eventData.page < eventData.pageCount) {
					eventData.pager.pagination("select", eventData.pageCount);
				}
			}
		};
		var m6 = {
			text : "移至最上",
			iconCls : "icon-standard-arrow-up",
			disabled : !(move == true || move.top == true),
			handler : function() {
				t.datagrid("moveRow", {
					source : rowIndex,
					target : 0,
		...
		var m7 = {
			text : "上移",
			iconCls : "icon-standard-up",
			disabled : !(move == true || move.up == true),
			handler : function() {
				t.datagrid("shiftRow", {
					point : "up",
					index : rowIndex
		...
		var m8 = {
			text : "下移",
			iconCls : "icon-standard-down",
			disabled : !(move == true || move.down == true),
			handler : function() {
				t.datagrid("shiftRow", {
					point : "down",
					index : rowIndex
		...
		var m9 = {
			...
			disabled : !(move == true || move.bottom == true),
			handler : function() {
		...
		mm.push(m1);
		var pagingMenu = [ m2, m3, m4, m5 ], moveMenu = [ m6, m7, "-", m8, m9 ], expMenu = [
				m10, m11 ];
		if (paging) {
			$.array
					.merge(mm, "-", typeof paging == "object"
							&& !paging.submenu ? pagingMenu : {
						text : "翻页",
						iconCls : "",
						disabled : !(paging == true || !paging.disabled),
						children : pagingMenu
					});
		}
		if (move) {
			$.array.merge(mm, "-",
					typeof move == "object" && !move.submenu ? moveMenu : {
						text : "上/下移动",
						iconCls : "",
						disabled : !move,
						children : moveMenu
	...
	$.fn.datagrid.extensions.parseHeaderContextMenuMap = function(e, field,
			eventData, contextMenu, t) {
		return $.array
				.map(
						contextMenu,
						function(value, index) {
							...
							var ret = $.extend({}, value);
							ret.id = $.isFunction(value.id) ? value.id.call(
									ret, e, field, eventData, t) : value.id;
							ret.text = $.isFunction(value.text) ? value.text
									.call(ret, e, field, eventData, t)
									: value.text;
							ret.iconCls = $.isFunction(value.iconCls) ? value.iconCls
									.call(ret, e, field, eventData, t)
									: value.iconCls;
							...
							ret.onclick = $.isFunction(value.onclick) ? function(
									e, item, menu) {
								value.onclick.call(this, e, field, eventData,
										t, item, menu);
							}
									: value.onclick;
							ret.handler = $.isFunction(value.handler) ? function(
									e, item, menu) {
								value.handler.call(this, e, field, eventData,
										t, item, menu);
							}
									: value.handler;
							if (ret.children && ret.children.length) {
								ret.children = $.fn.datagrid.extensions
										.parseHeaderContextMenuMap(e, field,
												eventData, ret.children, t);
							}
							return ret;
						});
	};

	$.fn.datagrid.extensions.parseRowContextMenuMap = function(e, rowIndex,
			rowData, eventData, contextMenu, t) {
		return $.array
				.map(
						contextMenu,
						function(value, index) {
							...
							var ret = $.extend({}, value);
							ret.id = $.isFunction(value.id) ? value.id.call(
									ret, e, rowIndex, rowData, eventData, t)
									: value.id;
							ret.text = $.isFunction(value.text) ? value.text
									.call(ret, e, rowIndex, rowData, eventData,
											t) : value.text;
							ret.iconCls = $.isFunction(value.iconCls) ? value.iconCls
									.call(ret, e, rowIndex, rowData, eventData,
											t)
							...
							ret.onclick = $.isFunction(value.onclick) ? function(
									e, item, menu) {
								value.onclick.call(this, e, rowIndex, rowData,
										eventData, t, item, menu);
							}
									: value.onclick;
							ret.handler = $.isFunction(value.handler) ? function(
									e, item, menu) {
								value.handler.call(this, e, rowIndex, rowData,
										eventData, t, item, menu);
							}
									: value.handler;
							if (ret.children && ret.children.length) {
								ret.children = $.fn.datagrid.extensions
										.parseRowContextMenuMap(e, rowIndex,
												rowData, eventData,
												ret.children, t);
							}
							return ret;
	...
	$.fn.datagrid.extensions.parseContextMenuEventData = function(t, opts, e) {
		...
		var pagingParams = $.fn.datagrid.extensions.parsePaginationParams(t,
				opts);
		return $.extend({}, queryParams, pagingParams, {
			e : e,
			grid : t
		});
	};
	...
	$.fn.datagrid.extensions.parsePaginationParams = function(t, opts) {
		...
		if (opts.pagination) {
			try {
				...
				var pageCount = Math.ceil(parseFloat(total)
						/ parseFloat(pagerOptions.pageSize));
				$.extend(ret, {
					pager : pager,
					total : total,
					pageCount : pageCount
	...
	var initColumnTooltip = function(t, opts) {
		...
		t
				...
				.each(
						function() {
							var tr = $(this), index = parseInt(tr
									.attr("datagrid-row-index")), row = rows[index];
	...
	var initColumnRowTooltip = function(t, opts, index, row, tr) {
		...
		if (opts.rowTooltip) {
			var onShow = function(e) {
				var tt = $(this), text = $.isFunction(opts.rowTooltip) ? opts.rowTooltip
						.call(tr, index, row)
						: buildText(row);
				tt.tooltip("update", text);
			};
			tr.each(function() {
				$.easyui.tooltip.init(this, {
					onShow : onShow
				});
			});
		} else {
			tr
					...
					.each(
							function() {
								var td = $(this), field = td.attr("field"), colOpts = t
										.datagrid("getColumnOption", field);
								if (!colOpts || !colOpts.tooltip) {
									return;
								}
								var cell = td.find("div.datagrid-cell"), onShow = function(
										e) {
									var tt = $(this), text = $
											.isFunction(colOpts.tooltip) ? colOpts.tooltip
											.call(cell, row[field], index, row)
											: row[field];
									tt.tooltip("update", text);
								};
								$.easyui.tooltip.init(cell, {
									onShow : onShow
								});
							});
		}
		function buildText(row) {
			var cols = t.datagrid("getColumns", "all"), content = $(
					"<table></table>").css({
				padding : "5px"
			});
			;
			$
					.each(
							cols,
							function(i, colOpts) {
								if (!colOpts || !colOpts.field
										|| !colOpts.title) {
									return;
								}
								var msg = t.datagrid("getCellDisplay", {
									field : colOpts.field,
									index : index
								});
								content
										.append("<tr><td style='text-align: right; width: 150px;'>"
												+ colOpts.title
	...
	var initializeRowExtEditor = function(t, opts, index) {
		...
		var view = t.datagrid("getPanel").find("div.datagrid-view"), view1 = view
				.find("div.datagrid-view1"), view2 = view
				.find("div.datagrid-view2"), body = view2
				.find("div.datagrid-body"), width = view1.outerWidth(), pos = view
				.position(), left = diff > 0 ? diff : 0;
		body.css("position", "relative");
		var height = tr.outerHeight(), top = tr.position().top + height
				+ body.scrollTop()
				- view2.find("div.datagrid-header").outerHeight();
		var p = $("<div></div>").addClass(
				"dialog-button datagrid-rowediting-panel").appendTo(body).css(
				"top", top).attr("datagrid-row-index", index);
		$("<a></a>").linkbutton({
			plain : false,
			iconCls : "icon-ok",
			text : "保存"
		...
		var diff = (opts.width - p.outerWidth()) / 2 - width, left = diff > 0 ? diff
				: 0;
		p.css("left", left);
	};
	...
	var removeRowExtEditor = function(t, body, index) {
		body = body
				|| t
						.datagrid("getPanel")
						.find(
								"div.datagrid-view div.datagrid-view2 div.datagrid-body");
		body.find(
				"div.datagrid-rowediting-panel[datagrid-row-index=" + index
						+ "]").remove();
	};
	...
	var disposeRowExtEditor = function(t, opts, index) {
		...
		body = t.datagrid("getPanel").find(
				"div.datagrid-view div.datagrid-view2 div.datagrid-body");
		removeRowExtEditor(t, body, index);
	};

	var initSingleEditing = function(t, opts, index) {
		var exts = opts._extensionsDatagrid ? opts._extensionsDatagrid
				: (opts._extensionsDatagrid = {});
		if (opts.singleEditing) {
			t.datagrid("endEdit", exts.lastEditingIndex);
		}
	...
	var initExtensions = $.fn.datagrid.extensions.initExtensions = function(t,
			opts) {
		var exts = opts._extensionsDatagrid ? opts._extensionsDatagrid
				: (opts._extensionsDatagrid = {});
		if (exts._initialized) {
		...
		exts.fields = $.array.filter(fields, function(val) {
			return t.datagrid("getColumnOption", val).title ? true : false;
		});
		exts.fieldOptions = $.array.map(exts.fields, function(val) {
			return t.datagrid("getColumnOption", val);
		});
		exts.fieldOptionsBackup = $.array.map(exts.fieldOptions, function(val) {
			return $.extend({}, val);
		});
		exts.filterData = [];
		...
		function initContextMenu() {
			initHeaderContextMenu(t, opts, exts);
			initRowContextMenu(t, opts, exts);
			initHeaderClickMenu(t, opts, exts);
		}
		;
		function initDblClickRow() {
			initDblClickRowEvent(t, opts, exts);
		}
		;
	...
	$.fn.datagrid.extensions.parseOrderbyParams = function(sortName, sortOrder) {
		sortName = $.string.isNullOrWhiteSpace(sortName) ? "" : $
				.trim(sortName);
	...
	$.fn.datagrid.extensions.parsePagingQueryParams = function(opts, param) {
		...
		ret.orderby = $.fn.datagrid.extensions.parseOrderbyParams(ret.sort,
				ret.order);
		return ret;
	};

	var clearFilterData = $.fn.datagrid.extensions.clearFilterData = function(
			opts) {
		var exts = opts._extensionsDatagrid ? opts._extensionsDatagrid
				: (opts._extensionsDatagrid = {});
		exts.filterData = [];
	...
	var loader = $.fn.datagrid.extensions.loader = function(param, success,
			error) {
	...
	var onLoadSuccess = $.fn.datagrid.extensions.onLoadSuccess = function(data) {
		if ($.isFunction(_onLoadSuccess)) {
			_onLoadSuccess.apply(this, arguments);
		}
		var t = $.util.parseJquery(this), opts = t.datagrid("options"), exts = opts._extensionsDatagrid ? opts._extensionsDatagrid
				: (opts._extensionsDatagrid = {});
		initHeaderColumnFilterContainer(t, opts, exts);
		initRowDndExtensions(t, opts);
	...
	var onResizeColumn = $.fn.datagrid.extensions.onResizeColumn = function(
			field, width) {
		if ($.isFunction(_onResizeColumn)) {
			_onResizeColumn.apply(this, arguments);
		}
		var t = $.util.parseJquery(this), opts = t.datagrid("options");
		if (opts.columnFilter) {
			var panel = t.datagrid("getPanel"), colOpts = t.datagrid(
					"getColumnOption", field), container = panel
					.find("div.datagrid-header-filter-container[field=" + field
							+ "]");
	...
	var onBeforeEdit = $.fn.datagrid.extensions.onBeforeEdit = function(index,
			row) {
	...
	var onAfterEdit = $.fn.datagrid.extensions.onAfterEdit = function(index,
			row, changes) {
		if ($.isFunction(_onAfterEdit)) {
			_onAfterEdit.apply(this, arguments);
		}
		var t = $.util.parseJquery(this), opts = t.datagrid("options"), exts = opts._extensionsDatagrid ? opts._extensionsDatagrid
				: (opts._extensionsDatagrid = {});
	...
	var onCancelEdit = $.fn.datagrid.extensions.onCancelEdit = function(index,
			row) {
		if ($.isFunction(_onCancelEdit)) {
			_onCancelEdit.apply(this, arguments);
		}
		var t = $.util.parseJquery(this), opts = t.datagrid("options");
		disposeRowExtEditor(t, opts, index);
		initRowDndExtensions(t, opts);
	...
	var methods = $.fn.datagrid.extensions.methods = {
		...
		// 扩展 easyui-datagrid 的自定义方法；判断指定的 data-row(数据行) 是否被 check；该方法的参数 index
		// 表示要判断的行的索引号，从 0 开始计数；
		// 返回值：如果参数 index 所表示的 data-row(数据行) 被 check，则返回 true，否则返回 false。
		isChecked : function(jq, index) {
			return isChecked(jq[0], index);
		},

		// 扩展 easyui-datagrid 的自定义方法；判断指定的 data-row(数据行) 是否被 select；该方法的参数 index
		// 表示要判断的行的索引号，从 0 开始计数；
		// 返回值：如果参数 index 所表示的 data-row(数据行) 被 select，则返回 true，否则返回 false。
		isSelected : function(jq, index) {
			return isSelected(jq[0], index);
		},
		...
		// 扩展 easyui-datagrid 的自定义方法；移动 easyui-datagrid 中的指定 data-row(数据行)
		// ；该方法的参数 param 为 JSON-Object 类型，包含如下属性定义：
		...
		// 扩展 easyui-datagrid 的自定义方法；移动 easyui-datagrid 中的指定 data-row(数据行)
		// 一行位置；该方法的参数 param 为 JSON-Object 类型，包含如下属性定义：
		...
		nextRow : function(jq, index) {
			return getNextRow(jq[0], index);
		},
		...
		prevRow : function(jq, index) {
			return getPrevRow(jq[0], index);
		},
		...
		popRow : function(jq, index) {
			return popRow(jq[0], index);
		},

		// 扩展 easyui-datagrid 的自定义方法；启用当前表格的行拖动功能；该方法无参数；
		// 返回值：返回表示当前 easyui-datagrid 的 jQuery 链式对象。
		enableRowDnd : function(jq) {
			return jq.each(function() {
				enableRowDnd(this);
			});
		},
		...
		// 返回值：返回表示当前 easyui-datagrid 的 jQuery 链式对象。
		disableRowDnd : function(jq) {
			return jq.each(function() {
				disableRowDnd(this);
			});
		},

		// 扩展 easyui-datagrid 的自定义方法；移动指定的列到另一位置；该方法的参数 param 为一个
		// JSON-Object，定义包含如下属性：
		...
		moveColumn : function(jq, param) {
			return jq.each(function() {
				moveColumn(this, param);
			});
		},

		// 扩展 easyui-datagrid 的自定义方法；移动指定的列挪动一格位置；该方法的参数 param 为一个
		// JSON-Object，定义包含如下属性：
		...
		// 返回值：返回表示当前 easyui-datagrid 的 jQuery 链式对象。
		// 注意：此方法在多行表头情况下无效。
		shiftColumn : function(jq, param) {
			return jq.each(function() {
				shiftColumn(this, param);
			});
		},

		// 扩展 easyui-datagrid 的自定义方法；获取指定列的下一格位置列的 列属性(columnOption) 信息；该方法的参数
		// field 表示指定列的 field 值。
		// 返回值：当前指定列的下一格位置的列的 列属性(columnOption) 信息。
		// 如果不存在指定的列，或者指定列的下一格位置没有其他列，则返回 null。
		nextColumn : function(jq, field) {
			return getNextColumn(jq[0], field);
		},

		// 扩展 easyui-datagrid 的自定义方法；获取指定列的上一格位置列的 列属性(columnOption) 信息；该方法的参数
		// field 表示指定列的 field 值。
		// 返回值：当前指定列的上一格位置的列的 列属性(columnOption) 信息。
		// 如果不存在指定的列，或者指定列的上一格位置没有其他列，则返回 null。
		prevColumn : function(jq, field) {
			return getPrevColumn(jq[0], field);
		},

		// 扩展 easyui-datagrid 的自定义方法；删除指定的列；该方法的参数 field 表示要删除的列的 field 值；
		// 返回值：返回表示当前 easyui-datagrid 的 jQuery 链式对象。
		deleteColumn : function(jq, field) {
			return jq.each(function() {
				deleteColumn(this, field);
			});
		},

		// 扩展 easyui-datagrid 的自定义方法；删除指定的列并返回该列的 ColumnOption 值；该方法的参数 field
		// 表示要删除的列的 field 值；
		// 返回值：返回参数 field 值所表示的列的 ColumnOption 值。如果当前 easyui-datagrid 不存在该列，则返回
		// null。
		popColumn : function(jq, field) {
			return popColumn(jq[0], param);
		},
		...
		// 返回值：如果当前页存在 field 值指定的列，则返回该列中指定行的 DOM-jQuery 对象，该对象中包含的 DOM 节点级别为一个
		// td[field=field] 对象；
		// 否则返回一个空的 jQuery 对象。
		// 如果 param 参数定义为 JSON-Object 类型，且 param.header = true，则返回的 DOM-jQuery
		// 对象中将会包含列的表头元素；
		// 如果 param 参数定义为 String 类型或者即使定义为 JSON-Object 类型但 param.header =
		// false，则返回的 DOM-jQuery 对象中不包含列的表头元素。
		getColumnDom : function(jq, param) {
			return getColumnDom(jq[0], param);
		},
		...
		// 如果传入的列名不存在，则返回数组的长度同样等于 grid.datagrid("getRows") 的长度，只是每个元素的值都为
		// undefined.
		getColumnData : function(jq, field) {
			return getColumnData(jq[0], field);
		},

		// 获取 easyui-datagrid 中当前页指定行的 DOM-jQuery 对象元素集合；该函数定义如下参数：
		// index: 表示要获取的 DOM-Jquery 对象元素集合所在当前页的行索引号；
		// 返回值：如果当前页存在 index 指示的行，则返回该行的 DOM-jQuery 对象集合，该集合中包含的 DOM 节点级别为一组 tr
		// class="datagrid-row" 对象；
		// 否则返回一个空的 jQuery 对象。
		getRowDom : function(jq, index) {
			return getRowDom(jq[0], index);
		},
		...
		// 返回值：如果当前页存在指定列的指定行，则返回该列中指定行的 DOM-jQuery 对象，该对象中包含的 DOM 节点级别为一个 div
		// class="datagrid-cell" 对象；
		// 否则返回一个空的 jQuery 对象。
		getCellDom : function(jq, pos) {
			return getCellDom(jq[0], pos);
		},
		...
		getCellData : function(jq, pos) {
			return getCellData(jq[0], pos);
		},
		...
		// field: 表示要获取的单元格位于哪个列；
		// index: 表示要获取的单元格位于哪个行的行索引号，从 0 开始；
		// 返回值：如果当前页存在指定列的指定行，则返回该列中指定行的单元格的显示数据(经过 formatter 格式化后的显示数据)；否则返回
		// undefined。
		getCellDisplay : function(jq, pos) {
			return getCellDisplay(jq[0], pos);
		},

		// 获取 easyui-datagrid 所有列的 field 所组成的一个数组集合；参数 frozen 可以定义为如下格式：
		// Boolean 类型值：如果是 true，则表示返回的结果集中包含 frozen(冻结)列，如果是 false 则表示返回的结果集中不包含
		// frozen(冻结)列；
		// String 类型值：如果该参数定义为任意 String 类型值，则返回所有列信息(包括 frozen 冻结列和非冻结列)；
		// 返回值：如果 frozen 参数定义为 Boolean 且为 true，则返回所有 frozen(冻结) 列的 field 所构成的一个
		// Array 数组对象；
		...
		getDistinctRows : function(jq, field) {
			return getDistinctRows(jq[0], field);
		},
		...
		// 如果传入的列名不存在，则返回一个长度为 0 的数组对象.
		getDistinctColumnData : function(jq, field) {
			return getDistinctColumnData(jq[0], field);
		},
		...
		// frozen(冻结)列；
		// String 类型值：如果该参数定义为任意 String 类型值，则返回所有列信息(包括 frozen 冻结列和非冻结列)；
		// 返回值：如果 frozen 参数定义为 Boolean 且为 true，则返回所有 frozen(冻结) 列的 columnOption
		// 所构成的一个 Array 数组对象；
		// 如果 frozen 参数定义为 false，则返回所有非 frozen(非冻结) 列的 columnOption 所构成的一个 Array
		// 数组对象；
		// 如果 frozen 定义为任意的 String 类型值，则返回所有列的 columnOption 所构成的一个 Array 数组对象。
		getColumns : function(jq, frozen) {
			return getColumns(jq[0], frozen);
		},

		// 同 getColumns 方法，但是仅返回列的 columnOption.hidden 值为 true 的列。
		getHiddenColumns : function(jq, frozen) {
			return getHiddenColumns(jq[0], frozen);
		},

		// 同 getColumns 方法，但是仅返回列的 columnOption.hidden 值为 false 的列。
		getVisibleColumns : function(jq, frozen) {
			return getVisibleColumns(jq[0], frozen);
		},

		// 同 getColumnFields 方法，但是仅返回列的 columnOption.hidden 值为 true 的列。
		getHiddenColumnFields : function(jq, frozen) {
			return getHiddenColumnFields(jq[0], frozen);
		},

		// 同 getColumnFields 方法，但是仅返回列的 columnOption.hidden 值为 false 的列。
		getVisibleColumnFields : function(jq, frozen) {
			return getVisibleColumnFields(jq[0], frozen);
		},

		// 显示当前 easyui-datagrid 当前页数据中指定行的数据；该方法的参数 param 可以是以下两种类型：
		// 待查找的行数据的 idField(主键) 字段值；
		// function 类型，该回调函数签名为 function(row, index, rows)，其中 row 表示行数据对象、index
		// 表示行索引号、rows 表示当前 easyui-datagrid 调用 getRows 返回的结果集；
		// 如果 param 参数为 function 类型，则 findRow 方法会对当前 easyui-datagrid
		// 的当前页的每一行数据调用该回调函数；
		...
		// Function 类型，该回调函数签名为 function(row, index, rows)，其中 row 表示行数据对象、index
		// 表示行索引号、rows 表示当前 easyui-datagrid 调用 getRows 返回的结果集；
		// 如果 param 参数为 Function 类型，则 showRows 方法会对当前 easyui-datagrid
		// 的当前页的每一行数据调用该回调函数；
		...
		// Function 类型，该回调函数签名为 function(row, index, rows)，其中 row 表示行数据对象、index
		// 表示行索引号、rows 表示当前 easyui-datagrid 调用 getRows 返回的结果集；
		// 如果 param 参数为 Function 类型，则 hideRows 方法会对当前 easyui-datagrid
		// 的当前页的每一行数据调用该回调函数；
		...
		getHiddenRows : function(jq) {
			return getHiddenRows(jq[0]);
		},

		// 获取当前 easyui-datagrid 当前页所有显示的行数据所构成的一个 Array 对象。
		getVisibleRows : function(jq) {
			return getVisibleRows(jq[0]);
		},

		// 使当前 easyui-datagrid 中指定的列 DOM 对象高亮显示；该函数定义如下参数：
		// field: 要高亮显示的列的 field 名；
		// 返回值：返回表示当前 easyui-datagrid 组件的 jQuery 链式对象。
		highlightColumn : function(jq, field) {
			return jq.each(function() {
				highlightColumn(this, field);
			});
		},
		...
		// 返回值：返回表示当前 easyui-datagrid 组件的 jQuery 链式对象。
		livesearch : function(jq, param) {
			return jq.each(function() {
				livesearch(this, param);
			});
		},

		// 检测当前 easyui-datagrid 控件是否存在多行表头；
		// 返回值：如果当前 easyui-datagrid 控件设置了多行表头，则返回 true，否则返回 false。
		hasMuliRowHeader : function(jq) {
			return hasMuliRowHeader(jq[0]);
		},
		...
		findRow : function(jq, param) {
			return findRow(jq[0], param);
		},

		// 查找当前数据页上的行数据；该方法的参数 param 可以是以下两种类型：
		// Function 类型，该回调函数签名为 function(row, index, rows)，其中 row 表示行数据对象、index
		// 表示行索引号、rows 表示当前 easyui-datagrid 调用 getRows 返回的结果集；
		// 如果 param 参数为 Function 类型，则 findRows 方法会对当前 easyui-datagrid
		// 的当前页的每一行数据调用该回调函数；
		...
		// 当 param 参数定义为 Array 类型时，则 findRows 方法会对数组中的每一项循环调用 findRow 方法，并过滤掉
		// findRow 方法返回 null 的结果行；
		// 返回值：返回一个 Array 数组对象；数组中的每一项都是 JSON-Object
		// 类型，表示一个行数据对象；如果未找到相应数据，则返回一个长度为 0 的数组对象。
		findRows : function(jq, param) {
			return findRows(jq[0], param);
		},

		// 删除一行数据，重写 easyui-datagrid 本身的 deleteRow 方法；参数 param
		// 表示要删除的项目；该参数可以是以下三种类型：
		// Number 类型，表示要删除的行索引号；
		// 表示要删除的行数据的 idField(主键) 字段值，或者行数据对象；
		// Function 类型，该回调函数签名为 function(row, index, rows)，其中 row 表示行数据对象、index
		// 表示行索引号、rows 表示当前 easyui-datagrid 调用 getRows 返回的结果集；
		// 如果 param 参数为 Function 类型，则 deleteRow 方法会对当前 easyui-datagrid
		// 的当前页的每一行数据调用该回调函数；
		...
		// Function 类型，该回调函数签名为 function(row, index, rows)，其中 row 表示行数据对象、index
		// 表示行索引号、rows 表示当前 easyui-datagrid 调用 getRows 返回的结果集；
		// 如果 param 参数为 Function 类型，则 deleteRows 方法会对当前 easyui-datagrid
		// 的当前页的每一行数据调用该回调函数；
		// 当回调函数返回 true 时，则表示查找到了需要被删除的行，deleteRows
		// 方法将会删除该行数据，并遍历下一行数据直至数数据集的末尾；
		// Array 类型，数组中的每一项目均表示要删除的行的行索引号或者 idField(主键) 字段值或者行数据对象
		// 返回值：返回表示当前 easyui-datagrid 组件的 jQuery 链式对象。
		deleteRows : function(jq, param) {
			return jq.each(function() {
				deleteRows(this, param);
			});
		},

		// 对数据列进行排序，参数 options 是一个 JSON 格式对象，该对象定义了如下属性：
		// sortName: String 类型，执行排序的字段名，必须是存在于 columns 或者 frozenColumns 中某项的
		// field 值。
		// sortOrder: String 类型，排序方式，可设定的值限定为 "asc" 或 "desc"，默认为 "asc"
		// 返回值：返回表示当前 easyui-datagrid 组件的 jQuery 链式对象。
		sort : function(jq, options) {
			return jq.each(function() {
				sortGrid(this, options);
			});
		},
		...
		// 返回值：返回表示当前 easyui-datagrid 组件的 jQuery 链式对象。
		setColumnWidth : function(jq, param) {
			return jq.each(function() {
				setColumnWidth(this, param);
			});
		},
		...
		// 返回值：返回表示当前 easyui-datagrid 组件的 jQuery 链式对象。
		setColumnFilter : function(jq, columnFilter) {
			return jq.each(function() {
				setColumnFilter(this, columnFilter);
			});
		},
		...
		// 返回值：返回表示当前 easyui-datagrid 组件的 jQuery 链式对象。
		columnFilterSelect : function(jq, param) {
			return jq.each(function() {
				columnFilterSelect(this, param);
			});
		},

		// 将当前表格数据导出为 excel 文件；该函数定义了一个参数 isAll；
		// 参数 isAll 指示是否导出全部而非仅当前页数据，如果不传入该参数默认为 false 即导出当前页数据。
		// 当参数 isAll 为 true 并且 remotePaging 为 true 时，需要当前 easyui-datagrid 控件的
		// url 属性指示的服务器数据源支持查询所有数据
		// （以 rows: 0 方式不分页查询所有数据）。
		// 返回值：返回表示当前 easyui-datagrid 组件的 jQuery 链式对象。
		exportExcel : function(jq, isAll) {
			return jq.each(function() {
				exportGrid(this, isAll);
			});
		}
	...
	var defaults = $.fn.datagrid.extensions.defaults = {
		...
		// 如果未定义 height 或者 height: 0，则表示屏幕大小调整时 easyui-datagrid 的 height
		// 属性撑满屏幕宽度；
		offset : null,
		...
		// 自动绑定的 onDblClickRow 的回调函数中将会调用 rowContextMenu 的第
		// "dblClickRowMenuIndex" 个菜单项的点击响应函数，但是回调函数中不能用到参数 e 和 menu。
		...
		// 备注：当设置了自定义属性 autoBindDblClickRow: true并且设置了有效的属性 rowContextMenu
		// 时，该功能方有效；
		// 如果此索引值超出菜单数量范围，则无效。
		dblClickRowMenuIndex : 0,

		// 增加 easyui-datagrid 的自定义扩展属性，该属性表示是否启用右键点击表头或者行数据时候弹出菜单中具有 "导出数据"
		// 菜单的功能；
		// 该属性可以定义为以下类型：
		...
		// 增加 easyui-datagrid 的自定义扩展属性，该属性表示表列头右键菜单，为一个 Array
		// 对象；数组中的每一个元素都具有如下属性:
		// id: 表示菜单项的 id；
		// text: 表示菜单项的显示文本；
		// iconCls: 表示菜单项的左侧显示图标；
		...
		// bold: Boolean 类型值，默认为 false；表示该菜单项是否字体加粗；
		// style: JSON-Object 类型值，默认为 null；表示要附加到该菜单项的样式；
		// handler: 表示菜单项的点击事件，该事件函数格式为 function(e, field, eventData, grid,
		// item, menu)，其中 this 指向菜单项本身
		// 备注：具体格式参考 easyui-datagrid 的 toolbar 属性为 Array 对象类型的格式；
		headerContextMenu : null,

		// 增加 easyui-datagrid 的自定义扩展属性，该属性表示数据行右键菜单，为一个 Array
		// 对象；；数组中的每一个元素都具有如下属性:
		// id: 表示菜单项的 id；
		// text: 表示菜单项的显示文本；
		// iconCls: 表示菜单项的左侧显示图标；
		...
		// bold: Boolean 类型值，默认为 false；表示该菜单项是否字体加粗；
		// style: JSON-Object 类型值，默认为 null；表示要附加到该菜单项的样式；
		// handler: 表示菜单项的点击事件，该事件函数格式为 function(e, rowIndex, rowData,
		// eventData, grid, item, menu)，其中 this 指向菜单项本身
		// 备注：具体格式参考 easyui-datagrid 的 toolbar 属性为 Array 对象类型的格式；
		rowContextMenu : null,
		...
		// 增加 easyui-datagrid 的自定义扩展属性，该属性表示在触发 beginEdit 事件后，是否构建仿
		// ext-grid-rowediting 行编辑的“保存”和“取消”按钮面板；
		// Boolean 类型值，默认为 true。
		extEditing : false,

		// 增加 easyui-datagrid 的自定义扩展属性，该属性表示在双击 data-row(数据行) 时，是否自动启用该行的编辑功能(执行
		// beginEdit 操作)；
		// Boolean 类型值，默认为 false。
		// 注意：当 autoBindDblClickRow 属性设置为 true 且菜单项满足其触发条件时，autoEditing
		// 的双击行时自动启用编辑效果将不会触发。
		autoEditing : false,

		// 增加 easyui-datagrid
		// 的自定义扩展属性，该属性表示是否在一个时刻只允许一行数据开启编辑状态(当某行数据开启编辑状态时，其他正在编辑的行将会被自动执行
		// endEdit 操作)；
		// Boolean 类型值，默认为 true。
		singleEditing : true,

		// 增加 easyui-datagrid 的自定义扩展属性，该属性表示当前表格的列过滤器设置参数；该参数是一个 JSON
		// 格式的对象，该对象定义如下属性：
		...
		// 4、当启用该功能时，easyui-datagrid 的属性 fitColumns 请保持默认值为
		// false，否则列头过滤器组件可能导致表头列不能对齐而布局混乱。
		columnFilter : null,
		...
		// $.fn.datagrid.extensions.onResizeColumn.apply(this, arguments);
		// //这句一定要加上。
		// ... //这里是调用者的其他附加逻辑代码
		// }
		// });
		...
		// 扩展 easyui-datagrid 的自定义事件；该事件表示移动 data-row(数据行)
		// 之前触发的动作；该事件回调函数提供如下三个参数：
		// target: 表示目标位置的 data-row(数据行) 索引号(从 0 开始计数)；
		// source: 表示要移动的 data-row(数据行) 索引号(从 0 开始计数)；
		// point: 表示移动到目标节点 target 的位置，String 类型，可能的值包括：
		// "top": 表示移动到目标位置 target 的上一格位置；
		...
		// 扩展 easyui-datagrid 的自定义事件；该事件表示拖动 data-row(数据行)
		// 之前触发的动作；该事件回调函数提供如下两个参数：
		...
		// 扩展 easyui-datagrid 的自定义事件；该事件表示开始拖动 data-row(数据行)
		// 时触发的动作；该事件回调函数提供如下两个参数：
		// index: 表示被拖动的 data-row(数据行) 的索引号，从 0 开始计数；
		// row: 表示被拖动的 data-row(数据行) 的行数据对象，是一个 JSON-Object。
		// 该事件函数中的 this 指向当前 easyui-datagrid 的 DOM 对象(非 jQuery 对象)；
		...
		// 扩展 easyui-datagrid 的自定义事件；该事件表示结束拖动 data-row(数据行)
		// 时触发的动作；该事件回调函数提供如下两个参数：
		// index: 表示被拖动的 data-row(数据行) 的索引号，从 0 开始计数；
		// row: 表示被拖动的 data-row(数据行) 的行数据对象，是一个 JSON-Object。
		// 该事件函数中的 this 指向当前 easyui-datagrid 的 DOM 对象(非 jQuery 对象)；
		...
		// 扩展 easyui-datagrid 的自定义事件；该事件表示当有其他的 data-row(数据行) 被拖动至当前
		// data-row(数据行) 时所触发的动作；该事件回调函数提供如下两个参数：
		// target: 表示当前 data-row(数据行) 的行数据对象，是一个 JSON-Object；
		// source: 表示拖动过来的 data-row(数据行) 行数据对象，是一个 JSON-Object。
		// 该事件函数中的 this 指向当前 easyui-datagrid 的 DOM 对象(非 jQuery 对象)；
		// 备注：如果该事件函数返回 false，则立即取消当前的 data-row(数据行) 接收拖动过来对象的操作，并禁用当前
		// data-row(数据行) 的 droppable 效果；
		onDragEnter : function(target, source) {
		},

		// 扩展 easyui-datagrid 的自定义事件；该事件表示当有其他的 data-row(数据行) 被拖动至当前
		// data-row(数据行) 后并在上面移动时所触发的动作；该事件回调函数提供如下两个参数：
		// target: 表示当前 data-row(数据行) 的行数据对象，是一个 JSON-Object；
		// source: 表示拖动过来的 data-row(数据行) 行数据对象，是一个 JSON-Object。
		// 该事件函数中的 this 指向当前 easyui-datagrid 的 DOM 对象(非 jQuery 对象)；
		// 备注：如果该事件函数返回 false，则立即取消当前的 data-row(数据行) 接收拖动过来对象的操作，并禁用当前
		...
		// 扩展 easyui-datagrid 的自定义事件；该事件表示当有其他的 data-row(数据行) 被拖动至当前
		// data-row(数据行) 后并拖动离开时所触发的动作；该事件回调函数提供如下两个参数：
		// target: 表示当前 data-row(数据行) 的行数据对象，是一个 JSON-Object；
		// source: 表示拖动过来的 data-row(数据行) 行数据对象，是一个 JSON-Object。
		// 该事件函数中的 this 指向当前 easyui-datagrid 的 DOM 对象(非 jQuery 对象)；
		...
		// 扩展 easyui-datagrid 的自定义事件；该事件表示执行 updateRow
		// 方法前所触发的动作；该事件回调函数提供如下两个参数：
		...
		// 扩展 easyui-datagrid 的自定义事件；该事件表示执行 insertRow
		// 方法前所触发的动作；该事件回调函数提供如下两个参数：
	...
	// 如果该属性为 Function 类型，则其格式为 function (value, rowIndex, rowData)，表示为该列启用
	// tooltip 的方式；
	...
	// "caps": 表示过滤器的类型为 slider 拖动条控件，且过滤的结果为只显示小于或等于 slider
	// 选定的值；只有该列全部为数值数据时，才能设置为该类型。
	// "lower": 表示过滤器的类型为 slider 拖动条控件，且过滤的结果为只显示大于或等于 slider
	// 选定的值；只有该列全部为数值数据时，才能设置为该类型。
	// precision: Number 类型，默认为 1；表示过滤器类型(filter)为 caps 或 lower 时候，slider
	// 组合控件的输入框的改变值的精度(保留的小数位数)。
	// step: Number 类型，默认为 1；表示过滤器类型(filter)为 caps 或 lower 时候，移动 slider
	// 控件时值的改变值的精度(最小改变的刻度)。
	//
	// 备注： 当 filterable 的值设置为 true 时，参数 filter 方有效；
	// 当 filterable 的值设置为 true 且 filter 的值为 "caps" 或 "lower" 时，参数 precision 和
	// step 方有效。
	...
	// 增加扩展插件中要用到的自定义样式
	var css = ".datagrid-rowediting-panel { position: absolute; display: block; border: 1px solid #ddd; padding: 5px 5px; }"
...
$
		.extend(
				$.fn.datagrid.defaults.editors,
				{
						...
						setValue : function(target, value) {
							...
							var formatDate = function(value) {
								...
								if (value instanceof Date) {
									...
									var regv = /^\d{4}(-|\/)\d{1,2}(-|\/)/;
									dt = new Date(value.replace(regv, RegExp.$1
											+ "/" + RegExp.$3 + "/"));
					...
					/*
					 * datebox1: { init: function(container, options){ var input =
					 * $('<input type="text" class="datagrid-editable-input"
					 * />'); input.appendTo(container); input.datebox({
					 * dateFmt:options.dateFmt }); return input; }, getValue:
					 * function(target){ return $(target).val(); }, setValue:
					 * function(target, value){ $(target).val(value); }, resize:
					...
					readonlytext : {
						init : function(container, options) {
							var input = $(
									'<input type="text" class="datagrid-editable-input  readonly" readOnly="readOnly">')
									.appendTo(container);
							return input;
						},
						getValue : function(target) {
...
(function($, undefined) {
	...
	var coreEasyui = {}, coreJquery = function() {
	...
	coreEasyui.getTopEasyuiTooltip = function() {
		...
		return $.util.$ && $.util.$.fn && $.util.$.fn.tooltip ? $.util.$.fn.tooltip
				: $.fn.tooltip;
	};
	coreEasyui.tooltip = $.fn.tooltip;
	// 对某个元素设置 easyui-tooltip 属性；该函数定义如下参数：
	// target: 表示要设置 easyui-tooltip 的元素，可以是一个 jQuery 选择器字符串，也可以是一个 DOM 对象或者
	// jQuery 对象。
	// options: 表示初始化 easyui-tooltip 的参数信息，为一个 JSON-Object；
	// 备注：通过该方法设置的 easyui-tooltip 属性，在触发 mouseover 事件时，加载 easyui-tooltip，在
	// tooltip-tip 隐藏时，easyui-tooltip 自动调用 destroy 销毁；
			...
			t.tooltip($.extend({
				...
				onHide : function() {
					if ($.isFunction(options.onHide)) {
						options.onHide.apply(this, arguments);
					}
					t.tooltip("destroy");
				}
			})).tooltip("show");
	...
	}, _show = $.messager.show, _alert = $.messager.alert, _confirm = $.messager.confirm, _prompt = $.messager.prompt, defaults = {
		title : "操作提醒",
		confirm : "您确认要进行该操作？",
		prompt : "请输入相应内容：",
		icon : "info",
	...
	$.messager.show = function(options) {
		var isString = $.util.isString(options) || $.util.isBoolean(options)
				|| $.isNumeric(options);
		if (isString) {
			return arguments.length == 1 ? $.messager.show({
				msg : String(options)
			}) : $.messager.show({
				title : options,
				msg : arguments[1],
		...
		var defaults = $.extend({}, $.messager.defaults, {
			title : "操作提醒",
			timeout : 4000,
			showType : "slide"
		});
		...
		opts.style = position[options.position] ? position[options.position]
				: position.topCenter;
		var iconCls = icons[opts.icon] ? icons[opts.icon] : icons.info;
		opts.msg = "<div class='messager-icon " + iconCls + "'></div>"
				+ "<div>" + opts.msg + "</div>";
		return _show(opts);
	};
	...
	$.messager.alert = function(title, msg, icon, fn) {
		if (arguments.length == 1) {
			return _alert(defaults.title, arguments[0], defaults.icon);
		}
		if (arguments.length == 2) {
			...
			if (arguments[1] in icons) {
				return _alert(defaults.title, arguments[0], arguments[1]);
			}
			return _alert.apply(this, arguments);
		}
		if (arguments.length == 3) {
			if ($.isFunction(arguments[2])) {
				return (arguments[1] in icons) ? _alert(defaults.title,
						arguments[0], arguments[1], arguments[2])
						: _alert(arguments[0], arguments[1], defaults.icon,
								arguments[2]);
			}
			return _alert.apply(this, arguments);
		}
	...
	$.messager.confirm = function(title, msg, fn) {
		if (arguments.length == 1) {
			return $.isFunction(arguments[0]) ? _confirm(defaults.title,
					defaults.confirm, arguments[0]) : _confirm(defaults.title,
					arguments[0]);
		}
		if (arguments.length == 2) {
			return $.isFunction(arguments[1]) ? _confirm(defaults.title,
					arguments[0], arguments[1]) : _confirm(arguments[0],
					arguments[1]);
		}
		return _confirm.apply(this, arguments);
	};

	// 增加 $.messager.solicit 方法，该方法弹出一个包含三个按钮("是"、"否" 和
	// "取消")的对话框，点击任意按钮或者关闭对话框时，执行指定的回调函数；
	// 该函数提供如下重载方式：
	// function (message, callback)
	// function (title, message, callback)
	// 返回值：返回弹出的消息框 easyui-window 对象
	$.messager.solicit = function(title, msg, fn) {
		var options = $.extend({}, (arguments.length == 2) ? {
		...
		var win = $.messager.confirm(options.title, options.msg, options.fn), opts = win
				.window("options"), onClose = opts.onClose;
		opts.onClose = function() {
			if ($.isFunction(onClose)) {
				onClose.apply(this, arguments);
			}
			if ($.isFunction(options.fn)) {
				options.fn.call(this, undefined);
			}
		};
	...
	$.messager.prompt = function(title, msg, fn) {
		if (arguments.length == 1) {
			return $.isFunction(arguments[0]) ? _prompt(defaults.title,
					defaults.prompt, arguments[0]) : _prompt(defaults.title,
					defaults.prompt);
		}
		if (arguments.length == 2) {
			return $.isFunction(arguments[1]) ? _prompt(defaults.title,
					arguments[0], arguments[1]) : _prompt(arguments[0],
					arguments[1]);
		}
	...
	// function ()
	// function (options)，其中 options 为一个格式为 { msg, locale, topMost } 的
	// JSON-Object；
	// 上述参数中：
	// msg 表示加载显示的消息文本内容，默认为 "正在加载，请稍等..."；
	// locale 表示加载的区域，可以是一个 jQuery 对象选择器字符串，也可以是一个 jQuery 对象或者 HTML-DOM
	// 对象；默认为字符串 "body"。
	// topMost 为一个布尔类型参数，默认为 false，表示是否在顶级页面加载此 mask 状态层。
	// 返回值：返回表示弹出的数据加载框和层的 jQuery 对象。
	coreEasyui.loading = function(options) {
		var opts = {
			msg : defaults.loading,
			locale : "body",
			topMost : false
		};
		options = options || {};
		$.extend(opts, options);
		var jq = opts.topMost ? $.util.$ : $, locale = jq.util
				.parseJquery(opts.locale), array = locale.children().map(
				function() {
					var zindex = $(this).css("z-index");
					return $.isNumeric(zindex) ? parseInt(zindex) : 0;
				}), zindex = $.array.max(array);
		locale.addClass("mask-container");
		var mask = jq("<div></div>").addClass("datagrid-mask").css({
			display : "block",
			"z-index" : ++zindex
		}).appendTo(locale);
		var msg = jq("<div></div>").addClass("datagrid-mask-msg").css({
			display : "block",
			left : "50%",
			"z-index" : ++zindex
		}).html(opts.msg).appendTo(locale);
	...
	$.extend($.fn.panel.defaults, {
		loadingMessage : defaults.loading
	});
	...
	coreEasyui.ajaxError = function(callback) {
		if (!arguments.length) {
			return $.fn.form.defaults.onLoadError;
		}
	...
	var onLoadError = function(XMLHttpRequest, textStatus, errorThrown) {
		...
		if (coreEasyui.messager != $.messager) {
			coreEasyui.messager.progress("close");
		}
		var msg = (XMLHttpRequest
				&& !$.string.isNullOrWhiteSpace(XMLHttpRequest.responseText) ? "如果该问题重复出现，请联系您的系统管理员并反馈该故障。<br />"
				+ "错误号："
		...
		var win = coreEasyui.messager.alert("错误提醒", msg, "error"), opts = win
				.window("options"), panel = win.window("panel"), width = panel
				.outerWidth(), height = panel.outerHeight()
		_w = $(window).width() - 20, _h = $(window).height() - 20;
		if (width < 800 || height > _h) {
			win.window("resize", {
				width : width < 800 ? 800 : width,
				height : height > _h ? _h : height
			});
		}
		win.window("center");
	};
			...
			.ajaxSetup({
				dataFilter : function(data, type) {
					return $.util.isString(type)
							&& type.toLowerCase(type) == "json" ? $.string
							.toJSONString(data) : data;
				}
			});

	// 判断当前 jQuery 对象是否是指定名称的已经初始化好的 easyui 插件；该方法定义如下参数：
	// pluginName：要判断的插件名称，例如 "panel"、"dialog"、"datagrid" 等；
	// 返回值：如果当前 jQuery 对象中的第一个 DOM 元素为 pluginName 参数所示的 easyui 插件且已经被初始化，则返回
	// true，否则返回 false。
	coreJquery.fn.isEasyUI = function(pluginName) {
		if (!$.array.contains($.parser.plugins, pluginName)) {
			$.error($.string.format("传入的参数 pluginName: {0} 不是 easyui 插件名。"));
		}
		if (!this.length) {
			return false;
		}
	...
	// pluginName：要判断的插件名称，例如 "panel"、"dialog"、"datagrid" 等；
	// 返回值：如果 selector 所表示的 jQuery 对象中的第一个 DOM 元素为 pluginName 参数所示的 easyui
	// 插件且已经被初始化，则返回 true，否则返回 false。
	...
	coreJquery.fn.currentPagination = function() {
		...
		while (p.length && !$.data(p[0], "pagination")) {
			p = p.parent().closest(".pagination");
		}
		return p;
	};
	...
	coreJquery.fn.currentProgressbar = function() {
		...
		while (p.length && !$.data(p[0], "progressbar")) {
			p = p.parent().closest(".progressbar");
		}
		return p;
	};
	...
	coreJquery.fn.currentTabPanel = function() {
		var p = this.closest(".panel-body"), panel = p.parent(), panels = panel
				.parent(), container = panels.parent();
		while (p.length
				&& !($.data(p[0], "panel") && panel.hasClass("panel")
						&& panels.hasClass("tabs-panels") && container
						.hasClass("tabs-container"))) {
			p = p.parent().closest(".panel-body");
			panel = p.parent();
			panels = panel.parent();
	...
	coreJquery.fn.currentTabs = function() {
		...
		while (p.length && !$.data(p[0], "tabs")) {
			p = p.parent().closest(".tabs-container");
		}
		return p;
	};
	...
	coreJquery.fn.currentAccordion = function() {
		...
		while (p.length && !$.data(p[0], "accordion")) {
			p = p.parent().closest(".accordion");
		}
		return p;
	};

	coreJquery.fn.currentAccPanel = function() {
		var p = this.closest(".panel-body"), panel = p.parent(), container = panels
				.parent();
		while (p.length
				&& !($.data(p[0], "panel") && panel.hasClass("panel")
						&& container.hasClass("accordion") && $.data(
						container[0], "accordion"))) {
			p = p.parent().closest(".panel-body");
			panel = p.parent();
			container = panels.parent();
		}
	...
	coreJquery.fn.currentLayout = function() {
		...
		while (layout.length && !$.data(layout[0], "layout")) {
			layout = layout.closest(".layout");
		}
		return layout;
	};

	coreJquery.fn.currentRegion = function() {
		var p = this.closest(".panel.layout-panel"), layout = p.parent(), body = p
				.children(".panel-body");
		while (p.length
				&& !(layout.hasClass("layout") && $.data(body[0], "panel"))) {
	...
	coreJquery.fn.currentLinkbutton = function() {
		...
		while (btn.length && !$.data(btn[0], "linkbutton")) {
			btn = btn.parent().closest(".layout");
		}
		return btn;
	};
	...
	coreJquery.fn.currentCalendar = function() {
		...
		while (c.length && !$.data(c[0], "calendar")) {
			c = c.parent().closest(".calendar");
		}
		return c;
	};
	...
	coreJquery.fn.currentWindow = function() {
		...
		while (p.length && !$.data(p[0], "window")) {
			p = p.parent().closest(".panel-body.window-body");
		}
		return p;
	};
	...
	coreJquery.fn.currentDialog = function() {
		var p = this.closest(".panel-body.window-body");
		while (p.length && !$.data(p[0], "dialog")) {
			p = p.parent().closest(".panel-body.window-body");
		}
		return p;
	};
	...
	coreJquery.fn.currentDatagrid = function() {
		var p = this.closest(".datagrid-wrap.panel-body"), dg = p
				.find(">.datagrid-view>eq(2)");
	...
	coreJquery.fn.currentPropertygrid = function() {
		var p = this.closest(".datagrid-wrap.panel-body"), pg = p
				.find(">.datagrid-view>eq(2)");
	...
	coreJquery.fn.currentTree = function() {
		...
		while (t.length && !$.data(t[0], "tree")) {
			t = t.parent().closest(".tree");
		}
		return t;
	};

	coreJquery.fn.currentTreegrid = function() {
		var p = this.closest(".datagrid-wrap.panel-body"), tg = p
				.find(">.datagrid-view>eq(2)");
...
(function($, undefined) {
						...
						.each(
								function() {
									...
									if (item.hasClass('menu-sep')) {
										...
										// var itemOpts = $.extend({},
										// $.parser.parseOptions(this, ['name',
										// 'iconCls', 'href']), {
										// 注释掉上一行代码，并添加了下一行代码，以实现获取 menu-item
										// 的属性 hideOnClick，该参数表示是否在点击菜单项后菜单自动隐藏
										var itemOpts = $
												.extend(
														{
															hideOnClick : true
										...
										// 添加了下一行代码，以实现将 menu-item 的 hideOnClick
										// 绑定到菜单项上
										item[0].hideOnClick = (itemOpts.hideOnClick == undefined
												|| itemOpts.hideOnClick == null ? true
												: itemOpts.hideOnClick);

										var text = item.addClass('menu-item')
												.html();
										item
												.empty()
												.append(
	...
	function setMenuWidth(target, menu) {
		...
		menu.find('div.menu-text').each(
				function() {
					...
					item.closest('div.menu-item')._outerHeight(
							item._outerHeight() + 2);
				});
		width += 65;
		menu._outerWidth(Math.max((menu[0].originalWidth || 0), width,
				opts.minWidth));
	...
	function bindMenuEvent(target, menu) {
		...
		// 注释掉上一行代码代码，并添加下面两行代码，以实现当菜单的 hideOnMouseLeave: true
		// 时，鼠标移出菜单控件时才自动隐藏，否则则是在菜单失去焦点后才隐藏。
		var state = $.data(target, 'menu'), opts = state.options;
		if (!opts.hideOnMouseLeave) {
			return;
		}
		;
	...
	function bindMenuItemEvent(target, item) {
		...
		item.bind('click.menu', function() {
			...
			if (!this.submenu) {
				// hideAll(target);
				// 注释掉上面一行代码，并添加下面一行代码，以实现当 menu-item 的属性 hideOnClick 为 false
				// 的情况下，点击菜单项不自动隐藏菜单控件。
				if (this.hideOnClick) {
					hideAll(target);
				}
	...
	var buildMenu = function(options) {
		var guid = $.util.guid("N", 12), id = "easyui_menu_id_" + guid, name = "easyui_menu_name_"
				+ guid;
		...
		$.each(opts.items, function(i, item) {
			if (opts.hideDisabledMenu && item.disabled) {
				return;
			}
			appendItemToMenu(menu, item, id, menu);
		});
		return {
			menu : menu,
			options : opts
	...
	var appendItemToMenu = function(menu, item, id, menus) {
		if ($.util.isString(item) && $.trim(item) == "-") {
		...
		if (item.hideDisabledMenu && item.disabled) {
			return;
		}
		...
		if ($.isFunction(item.handler)) {
			...
			item.onclick = function(e, item, menus) {
				handler.call(this, e, item, menus);
			};
		}
		if ($.isFunction(item.onclick)) {
			itemEle.click(function(e) {
				if (itemEle.hasClass("menu-item-disabled")) {
					return;
				}
				item.onclick.call(this, e, item, menus);
			});
		}
		var hasChild = item.children && item.children.length ? true : false, span = $(
				"<span></span>").text(item.text).appendTo(itemEle);
		if (item.bold) {
		...
		if (hasChild) {
			...
			$.each(item.children, function(i, n) {
				var val = $.util.isString(n) && $.trim(n) == "-" ? n : $
						.extend({
							hideDisabledMenu : item.hideDisabledMenu
						}, n);
	...
	$.extend($.easyui, {
		...
		// options: JSON 对象类型，参数属性继承 easyui-menu 控件的所有属性和事件（参考官方 API
		// 文档），并在此基础上增加了如下参数：
		// id: 一个 String 对象，表示创建的菜单对象的 ID 属性，如果不定义该参数，将会分配一个随机值。
		// name: 一个 String 对象，表示创建的菜单对象的 name 属性，如果不定义该参数，将会分配一个随机值。
		// hideDisabledMenu: 一个 Boolean 值，默认为 false；该属性表示当菜单项的 disabled:
		// true，是否自动隐藏该菜单项；
		// items: 一个 Array 对象，该数组对象中的每一个元素都是一个 JSON 格式对象用于表示一个 menu item （关于
		// menu item 对象属性，参考官方 API）；
		// 该数组中每个元素的属性，除 easyui-menu 中 menu item 官方 API 定义的属性外，还增加了如下属性：
		// hideDisabledMenu: 该属性表示在当前子菜单级别下当菜单项的 disabled: true，是否自动隐藏该菜单项；一个
		// Boolean 值，取上一级的 hideDisabledMenu 值；
		...
		// 另，如果同时定义了 onclick 和 handler，则只处理 handler 而不处理
		// onclick，所以请不要两个回调函数属性同时使用。
		// children: 同上一级对象的 items 属性，为一个 Array 对象；
		// 返回值：返回一个 JSON 格式对象，该返回的对象中具有如下属性：
		// menu: 依据于传入参数 options 构建出的菜单 DOM 元素对象，这是一个 jQuery 对象，该对象未初始化为
		// easyui-menu 控件，而只是具有该控件的 DOM 结构；
		...
		// createMenu: 仅根据传入的 options 参数创建出符合 easyui-menu DOM 结构要求的 jQuery DOM
		// 对象，但是该对象并未初始化为 easyui-menu 控件；
		// showMenu: 该方法在 createMenu 方法的基础上，对创建出来的 jQuery DOM 对象立即进行 easyui-menu
		// 结构初始化，并显示出来。
		// 返回值：返回一个 jQuery 对象，该对象表示创建并显示出的 easyui-menu 元素，该返回的元素已经被初始化为
		// easyui-menu 控件。
		showMenu : function(options) {
			...
			opts.onHide = function() {
				...
				if ($.isFunction(onHide1)) {
					onHide1.apply(this, arguments);
				}
				if ($.isFunction(onHide2)) {
					onHide2.apply(this, arguments);
				}
				$.util.exec(function() {
					m.menu("destroy");
				});
			...
			m.menu.menu(m.options).menu("show", {
				left : m.options.left,
				top : m.options.top
			});
			return m.menu;
	...
	// bold: Boolean 类型值，默认为 false；表示该菜单项是否字体加粗；
	// style: JSON-Object 类型值，默认为 null；表示要附加到该菜单项的样式；
	// 备注：上述增加的 menu-item 的自定义扩展属性，只有通过 $.easyui.createMenu 或者 $.easyui.showMenu
	// 生成菜单时，才有效。
...
if (window.jQuery) {
	...
	/*
	 * if ($.fn.calendar){ $.fn.calendar.defaults.weeks =
	 * ['日','一','二','三','四','五','六']; $.fn.calendar.defaults.months =
	 * ['一月','二月','三月','四月','五月','六月','七月','八月','九月','十月','十一月','十二月']; }
	 */
	/*
	 * if ($.fn.datebox){ $.fn.datebox.defaults.currentText = '今天';
	 * $.fn.datebox.defaults.closeText = '关闭'; $.fn.datebox.defaults.okText =
	 * '确定'; $.fn.datebox.defaults.missingMessage = '该输入项为必输项';
	 * $.fn.datebox.defaults.formatter = function(date){ var y =
	 * date.getFullYear(); var m = date.getMonth()+1; var d = date.getDate();
	 * return y+'-'+(m<10?('0'+m):m)+'-'+(d<10?('0'+d):d); };
	 * $.fn.datebox.defaults.parser = function(s){ if (!s) return new Date();
	 * var ss = s.split('-'); var y = parseInt(ss[0],10); var m =
	 * parseInt(ss[1],10); var d = parseInt(ss[2],10); if (!isNaN(y) &&
	 * !isNaN(m) && !isNaN(d)){ return new Date(y,m-1,d); } else { return new
	 * Date(); } }; } if ($.fn.datetimebox && $.fn.datebox){
	 * $.extend($.fn.datetimebox.defaults,{ currentText:
	 * $.fn.datebox.defaults.currentText, closeText:
	 * $.fn.datebox.defaults.closeText, okText: $.fn.datebox.defaults.okText,
