...
<#macro select
	...
	>
<#include "${ftl_route}/control.ftl"/><#rt/>
<select<#rt/>
<#if id!=""> id="${id}"</#if><#rt/>
<#if multiple!=""> multiple="${multiple}"</#if><#rt/>
<#include "${ftl_route}/common-attributes.ftl"/><#rt/>
<#include "${ftl_route}/scripting-events.ftl"/><#rt/>
><#rt/>
...
<#include "${ftl_route}/control-close.ftl"/><#rt/>
</#macro>
