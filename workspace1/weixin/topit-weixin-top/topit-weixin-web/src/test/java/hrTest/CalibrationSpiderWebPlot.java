...
//	public static final boolean DEFAULT_DRAW_RING = false; // 画换默认值
//	/**
//	 * 刻度数/环数
//	 */
...
//							angle = 0;
//						}
//						Rectangle2D radarArea0 = new Rectangle2D.Double(X+r, Y+r, W-2*r, H-2*r);
//						Point2D endPoint = getWebPoint(radarArea0, angle, 1);
//						polygon.addPoint((int)endPoint.getX(),(int)endPoint.getY());
//					}
//					g2.setPaint(Color.white);
//					g2.setStroke(new BasicStroke(1f));
//					g2.draw(polygon);
...
//		setLabelFont(new Font("宋体", Font.PLAIN, 14));
...
//				String label = format.format(((double) i / (double) ticks)
//						* this.getMaxValue());
...
//				// 添加刻度的前缀和后缀
//				if (null != this.getLablePrefix()
//						&& !"".equals(this.getLablePrefix())) {
//					label = this.getLablePrefix() + label;
//				}
//				if (null != this.getLableSuffix()
//						&& !"".equals(this.getLableSuffix())) {
...
//					g2.setPaint(new Color(79, 129, 189));
//					//g2.fill(head);
...
//						//g2.drawString(value + "", (int) (point.getX() - headW),
